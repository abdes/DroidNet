    ...
    where TSettings : class
{
        ...
        ILoggerFactory? loggerFactory = null)
    {
        ...
        this.settingsChangedSubscription = Observable.FromEvent<TSettings>(
                handler => eventHandler = settingsMonitor.OnChange(handler),
                _ => eventHandler?.Dispose())
    ...
    /// <inheritdoc />
    public abstract TSettings GetSettingsSnapshot();
