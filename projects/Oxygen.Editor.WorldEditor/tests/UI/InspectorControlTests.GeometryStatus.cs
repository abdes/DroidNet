...
public sealed partial class InspectorControlTests
{
    ...
    public Task GeometryPickerSharesStatusWithoutReplacingItsFocusedChoice() => EnqueueAsync(async () =>
    {
        ...
        using var model = new GeometryViewModel(CreateStatusHosting(), provider.Object, materials.Object, builtins, Mock.Of<Services.ISceneContentDemandService>()) { IsExpanded = true };
