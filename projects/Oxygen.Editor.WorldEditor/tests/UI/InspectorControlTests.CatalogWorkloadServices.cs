...
public sealed partial class InspectorControlTests
{
    private sealed partial class CatalogWorkloadServices : IDisposable
    {
        ...
        public CatalogWorkloadServices(NativeSceneFixture fixture)
        {
            ...
            this.Pipeline = new ContentPipelineService(this.Projects, this.Runs, this.Scopes, new SceneDescriptorGenerator(new ProceduralGeometryDescriptorService(api)), new ContentImportManifestBuilder(), new ContentImportManifestValidator(), api, this.Documents, this.compatibility);
