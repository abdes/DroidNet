...
public sealed partial class InspectorControlTests
{
    ...
    [TestMethod]
    [DataRow(920d, ElementTheme.Dark)]
    [DataRow(560d, ElementTheme.Light)]
    public Task MaterialDocumentDisplaysBackgroundCookStatus(double width, ElementTheme theme) => EnqueueAsync(async () =>
    {
        ...
        try
        {
            ...
            VisualUserInterfaceTestsApp.MainWindow.AppWindow.Resize(new((int)(width * scale) + 60, (int)(view.Height * scale) + 100));
            ...
            await this.CaptureComponentLayoutAsync(host, string.Create(System.Globalization.CultureInfo.InvariantCulture, $"material-status-{width}-{theme}.png")).ConfigureAwait(true);
