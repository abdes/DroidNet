...
namespace Oxygen::Interop {
  ...
  public:
    ...
    /// <summary>Completes after native startup has finished registering modules.</summary>
    auto WaitForEngineReadyAsync() -> System::Threading::Tasks::Task^;
