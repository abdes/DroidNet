...
namespace oxygen::interop::module {
  ...
  public:
    ...
    CreateSceneNodeCommand(std::string name, oxygen::scene::NodeHandle parent,
      System::Action<Oxygen::Managed::Core::NodeHandle>^
      managedCallback,
  ...
  private:
    ...
    Callback callback_;
    msclr::auto_gcroot<System::Action<Oxygen::Managed::Core::NodeHandle>^>
      managed_callback_;
  ...
  inline CreateSceneNodeCommand::CreateSceneNodeCommand(
    ...
    System::Action<Oxygen::Managed::Core::NodeHandle>^ managedCallback,
  ...
  inline void CreateSceneNodeCommand::Execute(CommandContext& context) {
    ...
    if (has_managed_callback_ && managed_callback_.get()) {
      ...
      Oxygen::Managed::Core::NodeHandle managedHandle(handle.Handle());
