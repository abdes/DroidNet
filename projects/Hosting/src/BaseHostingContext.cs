...
/// </summary>
/// <param name="lifeTimeLinked">Specifies whether the application lifetime and
/// the UI lifetime are linked.</param>
/// <remarks>
...
public class BaseHostingContext(bool lifeTimeLinked)
{
    ...
    /// </summary>
    /// <value>
    /// When <see langword="true" />, it indicates that the UI thread has been
