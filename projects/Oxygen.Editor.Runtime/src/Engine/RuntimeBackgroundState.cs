...
/// <param name="Exists">Whether the scene has an enabled sky sphere.</param>
/// <param name="Color">The stored scene-linear RGB value.</param>
/// <param name="AtmosphereEnabled">Whether atmosphere currently takes precedence over the sky sphere.</param>
