"""CSM-local entrypoint for the shared RenderDoc pass-focus analyzer."""
...
def _script_path():
    ...
    fallback = Path.cwd() / "tools" / "csm" / "AnalyzeRenderDocPassFocus.py"
    if fallback.exists():
...
def main() -> int:
    ...
    spec = importlib.util.spec_from_file_location(
        "_oxygen_renderdoc_pass_focus", script_path
    )
