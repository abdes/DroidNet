"""CSM-local entrypoint for the shared RenderDoc pass-timing analyzer."""
...
def _script_path():
    ...
    fallback = Path.cwd() / "tools" / "csm" / "AnalyzeRenderDocPassTiming.py"
    if fallback.exists():
...
def main() -> int:
    ...
    spec = importlib.util.spec_from_file_location(
        "_oxygen_renderdoc_pass_timing", script_path
    )
