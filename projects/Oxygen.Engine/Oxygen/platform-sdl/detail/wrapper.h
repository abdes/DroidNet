 ...
 public:
  ...
  auto GetNativeWindow(SDL_Window *window) const -> NativeWindowInfo override {
    ...
    void *hwnd = SDL_GetPointerProperty(SDL_GetWindowProperties(window),
                                        ...
                                        nullptr);
    native_window.window_handle = hwnd;
  ...
  [[nodiscard]] auto GetKeyName(SDL_Keycode key) const
