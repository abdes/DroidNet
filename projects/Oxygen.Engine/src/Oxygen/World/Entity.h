...
namespace entity {
     ...
     * returned.
     */
    OXYGEN_GFX_API auto CreateGameEntity(const GameEntityDescriptor& entity_desc)
        -> GameEntity;
     ...
     */
    OXYGEN_GFX_API auto RemoveGameEntity(GameEntity& entity) -> size_t;
...
public:
    ...
    OXYGEN_GFX_API [[nodiscard]] auto GetTransform() const noexcept -> Transform;
