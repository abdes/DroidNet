...
namespace entity {
   ...
   * that for a game entity id, the index and generation will be the same as for
   ...
   * create an Entity.
   *
   * @param entity_desc The descriptor containing the properties of the entity
   * to be created.
...
public:
  ...
  OXGN_GFX_NDAPI auto GetTransform() const noexcept -> Transform;
