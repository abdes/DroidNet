...
public:
    ...
    OXYGEN_GFX_API [[nodiscard]] auto GetPosition() const noexcept -> glm::vec3;
    OXYGEN_GFX_API [[nodiscard]] auto GetRotation() const noexcept -> glm::quat;
    OXYGEN_GFX_API [[nodiscard]] auto GetScale() const noexcept -> glm::vec3;

    OXYGEN_GFX_API void SetPosition(glm::vec3 position) const noexcept;
    OXYGEN_GFX_API void SetRotation(glm::quat rotation) const noexcept;
    OXYGEN_GFX_API void SetScale(glm::vec3 scale) const noexcept;
};
