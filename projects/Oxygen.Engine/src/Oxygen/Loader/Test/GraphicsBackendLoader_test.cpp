...
public:
  ...
  MOCK_METHOD(std::shared_ptr<oxygen::graphics::RenderController>, CreateRenderController, (const std::string_view, std::weak_ptr<oxygen::graphics::Surface>, uint32_t frames_in_flight), (override));
