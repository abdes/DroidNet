...
auto GetModuleFileNameSafe(HMODULE module) -> std::string
{
...
auto PlatformServices::IsMainExecutableModule(ModuleHandle moduleHandle) const
  -> bool
{
...
auto PlatformServices::GetRawFunctionAddress(ModuleHandle module,
