...
namespace detail {
    ...
    */
    ...
    public:
        ...
        OXYGEN_D3D12_API auto CreateRootSignature(const GraphicsPipelineDesc& desc) const
            -> dx::IRootSignature*;

        // Create a root signature from a ComputePipelineDesc root bindings
        OXYGEN_D3D12_API auto CreateRootSignature(const ComputePipelineDesc& desc) const
            -> dx::IRootSignature*;
    ...
    private:
        ...
        OXYGEN_D3D12_API auto GetOrCreateGraphicsPipeline(GraphicsPipelineDesc desc, size_t hash) -> Entry;
        OXYGEN_D3D12_API auto GetOrCreateComputePipeline(ComputePipelineDesc desc, size_t hash) -> Entry;

        // Cache access methods
        OXYGEN_D3D12_API auto GetGraphicsPipelineDesc(size_t hash) const -> const GraphicsPipelineDesc&;
        OXYGEN_D3D12_API auto GetComputePipelineDesc(size_t hash) const -> const ComputePipelineDesc&;
