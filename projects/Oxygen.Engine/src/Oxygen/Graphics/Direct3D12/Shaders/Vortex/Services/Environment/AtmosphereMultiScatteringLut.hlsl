    ...
    AtmosphereMultiScatteringLutPassConstants pass_constants)
{
    ...
    atmosphere_parameters.planet_radius_km = pass_constants.planet_radius_km;
    atmosphere_parameters.atmosphere_height_km = pass_constants.atmosphere_height_km;
    ...
    atmosphere_parameters.rayleigh_scattering_per_km_rgb = pass_constants.rayleigh_scattering_per_km_rgb.xyz;
    atmosphere_parameters.rayleigh_scale_height_km = pass_constants.rayleigh_scale_height_km;
    atmosphere_parameters.mie_scattering_per_km_rgb = pass_constants.mie_scattering_per_km_rgb.xyz;
    atmosphere_parameters.mie_scale_height_km = pass_constants.mie_scale_height_km;
    atmosphere_parameters.mie_extinction_per_km_rgb = pass_constants.mie_scattering_per_km_rgb.xyz
        + pass_constants.mie_absorption_per_km_rgb.xyz;
    atmosphere_parameters.mie_g = pass_constants.mie_anisotropy;
    atmosphere_parameters.absorption_per_km_rgb = pass_constants.ozone_absorption_per_km_rgb.xyz;
    atmosphere_parameters.absorption_density.layers[0].width_km = pass_constants.ozone_density_layer0.x;
    ...
    atmosphere_parameters.absorption_density.layers[1].width_km = pass_constants.ozone_density_layer1.x;
...
void VortexAtmosphereMultiScatteringLutCS(uint3 dispatch_id : SV_DispatchThreadID)
{
    ...
    float3 light_direction = float3(
        ...
        cosine_light_zenith);
    float view_height = atmosphere_parameters.planet_radius_km
        + texel_center_uv.y * atmosphere_parameters.atmosphere_height_km;
