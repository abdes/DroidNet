...
#include "Vortex/Contracts/Draw/DrawMetadata.hlsli" // Required by BindlessHelpers.hlsl.
#include "Vortex/Contracts/Draw/MaterialShadingConstants.hlsli" // Required by BindlessHelpers.hlsl.
