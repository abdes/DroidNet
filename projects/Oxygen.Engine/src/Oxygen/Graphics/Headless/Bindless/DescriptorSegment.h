...
public:
  ...
  auto Allocate() noexcept -> oxygen::bindless::HeapIndex override;
  auto Release(oxygen::bindless::HeapIndex index) noexcept -> bool override;
...
private:
  oxygen::bindless::HeapIndex base_index_;
  ...
  std::vector<oxygen::bindless::HeapIndex> free_list_;
