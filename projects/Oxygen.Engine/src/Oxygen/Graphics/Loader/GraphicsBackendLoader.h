...
*/
OXYGEN_LOADER_API auto LoadBackend(BackendType backend) -> GraphicsPtr;

//! Unloads the currently loaded graphics backend. If the backend has not been
//! shutdown, it will be.
OXYGEN_LOADER_API void UnloadBackend() noexcept;
...
*/
OXYGEN_LOADER_API auto GetBackend() noexcept -> GraphicsPtr;
