...
public:
  ...
  [[nodiscard]] constexpr auto BaseIndex() const noexcept
  {
    return base_index_;
  }
  [[nodiscard]] constexpr auto EndIndex() const noexcept
  {
    return base_index_ + count_;
  }
  ...
  friend constexpr auto operator==(
    const IndexRange& a, const IndexRange& b) noexcept -> bool
  {
...
inline void swap(IndexRange& a, IndexRange& b) noexcept { a.swap(b); }
