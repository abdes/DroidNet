...
public:
    ...
    OXYGEN_GFX_API [[nodiscard]] auto Width() const -> uint32_t override;
    OXYGEN_GFX_API [[nodiscard]] auto Height() const -> uint32_t override;
...
protected:
    ...
    /*!
      ...
      derived classes.
     */
    OXYGEN_GFX_API void InitializeSurface() override;
     ...
     */
    OXYGEN_GFX_API void ReleaseSurface() noexcept override;
