...
static const FormatInfo kFormatInfo[] = {
    ...
    { Format::kRG8UInt,            "RG8_UINT",              2,   1, FormatKind::kInteger,     true,  true,  false, false, false, false, false, false },
    { Format::kRG8SInt,            "RG8_SINT",              2,   1, FormatKind::kInteger,     true,  true,  false, false, false, false, true,  false },
    { Format::kRG8UNorm,           "RG8_UNORM",             2,   1, FormatKind::kNormalized,  true,  true,  false, false, false, false, false, false },
    { Format::kRG8SNorm,           "RG8_SNORM",             2,   1, FormatKind::kNormalized,  true,  true,  false, false, false, false, true,  false },
    { Format::kRG16UInt,           "RG16_UINT",             4,   1, FormatKind::kInteger,     true,  true,  false, false, false, false, false, false },
    { Format::kRG16SInt,           "RG16_SINT",             4,   1, FormatKind::kInteger,     true,  true,  false, false, false, false, true,  false },
    { Format::kRG16UNorm,          "RG16_UNORM",            4,   1, FormatKind::kNormalized,  true,  true,  false, false, false, false, false, false },
    { Format::kRG16SNorm,          "RG16_SNORM",            4,   1, FormatKind::kNormalized,  true,  true,  false, false, false, false, true,  false },
    { Format::kRG16Float,          "RG16_FLOAT",            4,   1, FormatKind::kFloat,       true,  true,  false, false, false, false, true,  false },
    { Format::kRG32UInt,           "RG32_UINT",             8,   1, FormatKind::kInteger,     true,  true,  false, false, false, false, false, false },
    { Format::kRG32SInt,           "RG32_SINT",             8,   1, FormatKind::kInteger,     true,  true,  false, false, false, false, true,  false },
    { Format::kRG32Float,          "RG32_FLOAT",            8,   1, FormatKind::kFloat,       true,  true,  false, false, false, false, true,  false },
    { Format::kRGB32UInt,          "RGB32_UINT",           12,   1, FormatKind::kInteger,     true,  true,  true,  false, false, false, false, false },
    { Format::kRGB32SInt,          "RGB32_SINT",           12,   1, FormatKind::kInteger,     true,  true,  true,  false, false, false, true,  false },
    { Format::kRGB32Float,         "RGB32_FLOAT",          12,   1, FormatKind::kFloat,       true,  true,  true,  false, false, false, true,  false },
    { Format::kRGBA8UInt,          "RGBA8_UINT",            4,   1, FormatKind::kInteger,     true,  true,  true,  true,  false, false, false, false },
    { Format::kRGBA8SInt,          "RGBA8_SINT",            4,   1, FormatKind::kInteger,     true,  true,  true,  true,  false, false, true,  false },
    { Format::kRGBA8UNorm,         "RGBA8_UNORM",           4,   1, FormatKind::kNormalized,  true,  true,  true,  true,  false, false, false, false },
    { Format::kRGBA8UNormSRGB,     "SRGBA8_UNORM",          4,   1, FormatKind::kNormalized,  true,  true,  true,  true,  false, false, false, true  },
    { Format::kRGBA8SNorm,         "RGBA8_SNORM",           4,   1, FormatKind::kNormalized,  true,  true,  true,  true,  false, false, true,  false },
    { Format::kBGRA8UNorm,         "BGRA8_UNORM",           4,   1, FormatKind::kNormalized,  true,  true,  true,  true,  false, false, false, false },
    { Format::kBGRA8UNormSRGB,     "SBGRA8_UNORM",          4,   1, FormatKind::kNormalized,  true,  true,  true,  true,  false, false, false, true  },
    { Format::kRGBA16UInt,         "RGBA16_UINT",           8,   1, FormatKind::kInteger,     true,  true,  true,  true,  false, false, false, false },
    { Format::kRGBA16SInt,         "RGBA16_SINT",           8,   1, FormatKind::kInteger,     true,  true,  true,  true,  false, false, true,  false },
    { Format::kRGBA16UNorm,        "RGBA16_UNORM",          8,   1, FormatKind::kNormalized,  true,  true,  true,  true,  false, false, false, false },
    { Format::kRGBA16SNorm,        "RGBA16_SNORM",          8,   1, FormatKind::kNormalized,  true,  true,  true,  true,  false, false, true,  false },
    { Format::kRGBA16Float,        "RGBA16_FLOAT",          8,   1, FormatKind::kFloat,       true,  true,  true,  true,  false, false, true,  false },
    { Format::kRGBA32UInt,         "RGBA32_UINT",          16,   1, FormatKind::kInteger,     true,  true,  true,  true,  false, false, false, false },
    { Format::kRGBA32SInt,         "RGBA32_SINT",          16,   1, FormatKind::kInteger,     true,  true,  true,  true,  false, false, true,  false },
    { Format::kRGBA32Float,        "RGBA32_FLOAT",         16,   1, FormatKind::kFloat,       true,  true,  true,  true,  false, false, true,  false },
