...
NOLINT_TEST_F(BaseDescriptorAllocatorErrorTest, ReleaseFromDifferentAllocatorThrows)
{
    ...
    const auto allocator1 = std::make_unique<::testing::NiceMock<MockDescriptorAllocator>>();
    const auto allocator2 = std::make_unique<::testing::NiceMock<MockDescriptorAllocator>>();
