...
public:
  ...
  MOCK_METHOD(void, ExecuteIndirectCounted, (const oxygen::graphics::Buffer&, std::uint64_t, std::uint32_t, oxygen::graphics::CommandRecorder::IndirectCommandLayout, const oxygen::graphics::Buffer&, std::uint64_t), (override));
