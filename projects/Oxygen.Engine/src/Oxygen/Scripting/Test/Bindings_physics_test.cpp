...
NOLINT_TEST_F(PhysicsBindingsTest, ParseCollisionShapeSupportsAllShapeTypes)
{
...
NOLINT_TEST_F(PhysicsBindingsTest, ParseCollisionShapeRejectsInvalidContracts)
{
  lua_State* state = luaL_newstate();
  ASSERT_NE(state, nullptr);
