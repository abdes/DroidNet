...
namespace detail {
  ...
  public:
    ...
    {
      SanitizedAwaiter<Awaitable&&> awaiter(std::forward<Awaitable>(awaitable));
...
template <class EventLoop, class Awaitable>
OXYGEN_NOINLINE auto Run(EventLoop& event_loop, Awaitable&& awaitable)
  -> decltype(auto)
{
