...
*/
template <typename T> class IntrusiveListItem {
public:
...
template <typename T, typename Item> class IntrusiveListIterator;
...
template <typename T> class IntrusiveList final : public IntrusiveListItem<T> {
public:
  using iterator = IntrusiveListIterator<T, IntrusiveListItem<T>>;
  using const_iterator
    = IntrusiveListIterator<const T, const IntrusiveListItem<T>>;
  ...
  {
    return iterator(static_cast<T*>(this->next_));
  }
  [[nodiscard]] auto begin() const -> const_iterator
  {
    return const_iterator(static_cast<const T*>(this->next_));
  }
...
template <class T, class Item> class IntrusiveListIterator {
public:
  ...
  friend auto operator==(
    const IntrusiveListIterator& lhs, const IntrusiveListIterator& rhs) -> bool
  {
