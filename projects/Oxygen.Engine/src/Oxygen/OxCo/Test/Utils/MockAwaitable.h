...
public:
    MOCK_METHOD(bool, await_ready, (), (const, noexcept, override)); // NOLINT(modernize-use-trailing-return-type)
    MOCK_METHOD(void, await_suspend, (Handle), (override));
    MOCK_METHOD(int, await_resume, (), (override)); // NOLINT(modernize-use-trailing-return-type)
    MOCK_METHOD(bool, await_early_cancel, (), (noexcept, override)); // NOLINT(modernize-use-trailing-return-type)
    MOCK_METHOD(bool, await_cancel, (Handle), (noexcept, override)); // NOLINT(modernize-use-trailing-return-type)
    MOCK_METHOD(bool, await_must_resume, (), (const, noexcept, override)); // NOLINT(modernize-use-trailing-return-type)
};
...
public:
    ...
    [[nodiscard]] auto await_cancel(const std::coroutine_handle<> h) noexcept -> bool override
    {
