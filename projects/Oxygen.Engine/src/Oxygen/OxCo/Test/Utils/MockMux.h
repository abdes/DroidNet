...
public:
  ...
  [[nodiscard]] virtual auto Parent() const noexcept
    -> const detail::Handle& = 0;
};
...
private:
  ...
  template <class, class> friend class oxygen::co::detail::MuxHelper;
};
