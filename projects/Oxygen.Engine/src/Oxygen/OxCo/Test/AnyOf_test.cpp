...
struct Ready {
    ...
    // NOLINTNEXTLINE(*-convert-member-functions-to-static)
    [[maybe_unused]] auto await_cancel(Handle /*unused*/) noexcept -> bool { return false; }
    // NOLINTNEXTLINE(*-convert-member-functions-to-static)
    [[nodiscard]] [[maybe_unused]] auto await_must_resume() const noexcept -> bool { return true; }
};
...
struct ReadyCancellable {
    ...
    void await_resume() noexcept { }
    // NOLINTNEXTLINE(*-convert-member-functions-to-static)
    [[maybe_unused]] auto await_cancel(Handle) noexcept { return std::true_type {}; }
};
