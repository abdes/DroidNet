...
| PhaseSnapshot (build immutable frame snapshot) | A | Ordered | No | No | No — modules run synchronously on main thread to prepare views; Engine consolidates and publishes snapshot last | No | B4 (Barrier_SnapshotReady) |
