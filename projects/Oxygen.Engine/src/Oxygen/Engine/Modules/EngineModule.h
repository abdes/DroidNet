...
namespace engine {
  ...
  public:
    ...
    [[nodiscard]] virtual auto GetPriority() const noexcept -> ModulePriority
      = 0;
    ...
    */
    virtual auto OnAttached(observer_ptr<Engine> /*engine*/) noexcept -> bool
    {
      return true;
    }
    ...
    */
    ...
    virtual auto OnGameplay(FrameContext& /*context*/) -> co::Co<>
    {
      co_return;
    }
    ...
    virtual auto OnAsyncPoll(FrameContext& /*context*/) -> co::Co<>
    {
      co_return;
    }
