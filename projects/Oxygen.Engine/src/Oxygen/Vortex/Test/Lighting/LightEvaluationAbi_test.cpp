    ...
    LightingGpuAbiTest, LocalEvaluationDecodesEveryLaneAndIntegerFlags)
  {
    const auto records = std::array {
      ...
      ForwardLocalLightRecord {
        ...
        .inner_cone_sin_half_squared = 0.125F,
        .outer_cone_sin_half_squared = 0.5F,
        .kind = 0U,
        .flags = 0x80000001U,
      ...
      ForwardLocalLightRecord {
        ...
        .inner_cone_sin_half_squared = 0.25F,
        .outer_cone_sin_half_squared = 0.375F,
        .kind = 1U,
        .flags = 0x01000003U,
    ...
    LightingGpuAbiTest, LightingHeaderDecodesAllDescriptorsAndFullGenerations)
  {
    const auto records = std::array {
      ...
      LightingFrameBindings {
        ...
        .brdf_moments_srv = ShaderVisibleIndex { 22U },
        .brdf_mean_moments_srv = ShaderVisibleIndex { 23U },
        .brdf_model_revision = 1U,
      },
      LightingFrameBindings {},
    };
    const auto expected = std::vector<std::uint32_t> {
