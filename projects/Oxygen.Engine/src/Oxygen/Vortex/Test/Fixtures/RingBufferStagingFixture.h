...
protected:
  ...
  static auto ComputeStatsDelta(
    const oxygen::vortex::upload::StagingProvider::StagingStats& before,
    const oxygen::vortex::upload::StagingProvider::StagingStats& after)
    -> oxygen::vortex::upload::StagingProvider::StagingStats
  {
    using Stats = oxygen::vortex::upload::StagingProvider::StagingStats;
    Stats d {};
