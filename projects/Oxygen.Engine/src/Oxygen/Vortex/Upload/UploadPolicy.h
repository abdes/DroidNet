...
struct UploadPolicy {
  ...
  OXGN_VRTX_API explicit UploadPolicy(oxygen::graphics::QueueKey qkey) noexcept;
  OXGN_VRTX_API UploadPolicy(
    oxygen::graphics::QueueKey qkey, AlignmentPolicy alignment_policy) noexcept;
  UploadPolicy() = delete;
};

OXGN_VRTX_API auto DefaultUploadPolicy() -> UploadPolicy;
