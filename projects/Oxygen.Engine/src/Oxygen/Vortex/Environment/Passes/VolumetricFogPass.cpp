  ...
  -> RecordState
{
  ...
  auto retire_unpublished = ScopeGuard([&] noexcept -> void {
  ...
  constants.grid_z.directional_shadows_enabled
    = renderer_.GetVolumetricFogDirectionalShadowsEnabled() ? 1U : 0U;
  ...
  state.directional_shadowed_light_injection_requested
    = constants.grid_z.directional_shadows_enabled != 0U;
