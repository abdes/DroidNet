...
namespace {
  ...
  auto BuildSkyFramebuffer(const SceneTextures& scene_textures)
  ...
  auto BuildSkyPipelineDesc(const SceneTextures& scene_textures)
    -> graphics::GraphicsPipelineDesc
  {
    ...
    .SetVertexShader(graphics::ShaderRequest {
      ...
      .source_path = "Vortex/Services/Environment/Sky.hlsl",
      .entry_point = "VortexSkyPassVS",
    })
    .SetPixelShader(graphics::ShaderRequest {
      .stage = ShaderType::kPixel,
      .source_path = "Vortex/Services/Environment/Sky.hlsl",
      .entry_point = "VortexSkyPassPS",
    })
    ...
    .SetDebugName("Vortex.Environment.Sky")
    .Build();
  }
...
SkyPass::SkyPass(Renderer& renderer)
  : renderer_(renderer)
{
}
...
auto SkyPass::Record(RenderContext& ctx, graphics::CommandRecorder& recorder,
  const SceneTextures& scene_textures) const -> RecordState
{
  ...
  auto framebuffer
    = gfx->CreateFramebuffer(BuildSkyFramebuffer(scene_textures));
  ...
  recorder.SetPipelineState(BuildSkyPipelineDesc(scene_textures));
