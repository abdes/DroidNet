...
public:
  ...
  AtmosphereMultiScatteringLutPass(const AtmosphereMultiScatteringLutPass&) = delete;
  auto operator=(const AtmosphereMultiScatteringLutPass&)
    -> AtmosphereMultiScatteringLutPass& = delete;
  AtmosphereMultiScatteringLutPass(AtmosphereMultiScatteringLutPass&&) = delete;
