...
auto BuildVortexRootBindings() -> std::vector<graphics::RootBindingItem>
{
  ...
  for (std::uint32_t index = 0U;
    index < bindless_d3d12::kRootParamTableCount; ++index) {
...
auto BuildTranslucencyPipelineDesc(
...
auto TranslucencyModule::Execute(
  ...
  -> TranslucencyExecutionResult
{
  ...
  recorder->SetPipelineState(
    BuildTranslucencyPipelineDesc(scene_textures, reverse_z));
