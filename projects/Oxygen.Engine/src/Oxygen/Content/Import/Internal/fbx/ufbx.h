...
#if defined(_MSC_VER)
#  pragma warning(push)
#  pragma warning(disable : 4061) // enumerator 'ENUM' in switch of enum 'enum'
...
#  pragma warning(disable                                                      \
    : 4820) // type': 'N' bytes padding added after data member 'member'
...
// If you want to isolate ufbx to a single translation unit you can do the
// following:
//   #define UFBX_STATIC
//   #include "ufbx.h"
//   #include "ufbx.c"
...
#  define UFBX_CONVERSION_IMPL(p_name)                                         \
    template <typename T,                                                      \
      typename S = typename ufbxi_type_is<T,                                   \
        decltype(ufbx_converter<T>::from(*(const p_name*)nullptr))>::type>     \
    operator T() const                                                         \
    {                                                                          \
...
#  define UFBX_CONVERSION_TO_IMPL(p_name)                                      \
    template <typename T,                                                      \
      typename S = typename ufbxi_type_is<p_name,                              \
        decltype(ufbx_converter<T>::to(*(const T*)nullptr))>::type>            \
    p_name(const T& t)                                                         \
    {                                                                          \
...
#  define UFBX_CONVERSION_LIST_IMPL(p_name)                                    \
    template <typename T,                                                      \
      typename S = typename ufbxi_type_is<T,                                   \
        decltype(ufbx_converter<T>::from_list(                                 \
...
#define ufbx_pack_version(major, minor, patch)                                 \
  ((major) * 1000000u + (minor) * 1000u + (patch))
...
// HINT: The version can be compared numerically to the result of
// `ufbx_pack_version()`, for example `#if UFBX_VERSION >= ufbx_pack_version(0,
// 12, 0)`.
...
UFBX_ENUM_TYPE(
  ufbx_rotation_order, UFBX_ROTATION_ORDER, UFBX_ROTATION_ORDER_SPHERIC);
...
UFBX_ENUM_TYPE(
  ufbx_dom_value_type, UFBX_DOM_VALUE_TYPE, UFBX_DOM_VALUE_ARRAY_IGNORED);
...
UFBX_ENUM_TYPE(
  ufbx_element_type, UFBX_ELEMENT_TYPE, UFBX_ELEMENT_METADATA_OBJECT);
...
UFBX_ENUM_TYPE(
  ufbx_inherit_mode, UFBX_INHERIT_MODE, UFBX_INHERIT_MODE_COMPONENTWISE_SCALE);
...
typedef struct ufbx_vertex_attrib {
  ...
  // NOTE: This is not loaded by default, set
  // `ufbx_load_opts.retain_vertex_attrib_w`.
...
UFBX_LIST_TYPE(
  ufbx_subdivision_weight_range_list, ufbx_subdivision_weight_range);
...
struct ufbx_mesh {
  ...
  size_t
    max_face_triangles; // < Maximum number of triangles in a  face in this mesh
...
UFBX_ENUM_TYPE(
  ufbx_light_area_shape, UFBX_LIGHT_AREA_SHAPE, UFBX_LIGHT_AREA_SHAPE_SPHERE);
...
UFBX_ENUM_TYPE(
  ufbx_aspect_mode, UFBX_ASPECT_MODE, UFBX_ASPECT_MODE_FIXED_HEIGHT);
...
UFBX_ENUM_TYPE(
  ufbx_aperture_mode, UFBX_APERTURE_MODE, UFBX_APERTURE_MODE_FOCAL_LENGTH);
...
UFBX_ENUM_TYPE(
  ufbx_aperture_format, UFBX_APERTURE_FORMAT, UFBX_APERTURE_FORMAT_IMAX);
...
UFBX_ENUM_TYPE(
  ufbx_coordinate_axis, UFBX_COORDINATE_AXIS, UFBX_COORDINATE_AXIS_UNKNOWN);
...
UFBX_ENUM_TYPE(
  ufbx_nurbs_topology, UFBX_NURBS_TOPOLOGY, UFBX_NURBS_TOPOLOGY_CLOSED);
...
struct ufbx_blend_shape {
  ...
  // NOTE: These are technically not supported in FBX and are only written by
  // Blender.
...
UFBX_ENUM_TYPE(
  ufbx_cache_file_format, UFBX_CACHE_FILE_FORMAT, UFBX_CACHE_FILE_FORMAT_MC);
...
UFBX_ENUM_TYPE(
  ufbx_shader_texture_type, UFBX_SHADER_TEXTURE_TYPE, UFBX_SHADER_TEXTURE_OSL);
...
// ufbx can parse a small subset of these, as normal maps are often hidden
// behind some kind of bump node. NOTE: These encode a lot of details of 3ds Max
// internals, not recommended for direct use. HINT:
// `ufbx_texture.file_textures[]` contains a list of "real" textures that are
// connected to the `ufbx_texture` that is pretending to be a shader node.
...
struct ufbx_texture {
  ...
  // UV transform
  bool
    has_uv_transform; // < Has a non-identity `transform` and derived matrices.
...
UFBX_ENUM_TYPE(
  ufbx_interpolation, UFBX_INTERPOLATION, UFBX_INTERPOLATION_CUBIC);
...
typedef enum ufbx_extrapolation_mode UFBX_ENUM_REPR {
  ...
  UFBX_EXTRAPOLATION_SLOPE, // < Use the tangent of the last keyframe to
                            // linearly extrapolate
  UFBX_EXTRAPOLATION_REPEAT_RELATIVE, // < Repeat the animation curve but
                                      // connect the first and last keyframe
                                      // values

  UFBX_ENUM_FORCE_WIDTH(UFBX_EXTRAPOLATION)
} ufbx_extrapolation_mode;

UFBX_ENUM_TYPE(ufbx_extrapolation_mode, UFBX_EXTRAPOLATION_MODE,
...
UFBX_ENUM_TYPE(
  ufbx_constraint_type, UFBX_CONSTRAINT_TYPE, UFBX_CONSTRAINT_SINGLE_CHAIN_IK);
...
UFBX_ENUM_TYPE(
  ufbx_warning_type, UFBX_WARNING_TYPE, UFBX_WARNING_UNKNOWN_OBJ_DIRECTIVE);
...
UFBX_ENUM_TYPE(
  ufbx_thumbnail_format, UFBX_THUMBNAIL_FORMAT, UFBX_THUMBNAIL_FORMAT_RGBA_32);
...
typedef enum ufbx_pivot_handling UFBX_ENUM_REPR {
  ...
  // `ufbx_geometry_transform_handling`
  // to interpret these in a standard scene graph.
  // NOTE: By default the original transforms of empties are not retained when
  // using this,
  // use `ufbx_load_opts.pivot_handling_retain_empties` to prevent adjusting
  // these pivots.
...
UFBX_ENUM_TYPE(
  ufbx_time_protocol, UFBX_TIME_PROTOCOL, UFBX_TIME_PROTOCOL_DEFAULT);
...
typedef struct ufbx_scene_settings {
  ...
  // HINT: Use `ufbx_scene_settings.frames_per_second` instead of interpreting
  // these yourself.
...
typedef struct ufbx_vertex_stream {
  ...
  size_t
    vertex_count; // < Number of vertices in this stream, for sanity checking.
...
typedef void* ufbx_realloc_fn(
  void* user, void* old_ptr, size_t old_size, size_t new_size);
...
UFBX_ENUM_TYPE(
  ufbx_open_file_type, UFBX_OPEN_FILE_TYPE, UFBX_OPEN_FILE_OBJ_MTL);

typedef uintptr_t ufbx_open_file_context;

typedef struct ufbx_open_file_info {
  // Context that can be passed to the following functions to use a shared
  // allocator:
  //   ufbx_open_file_ctx()
...
typedef bool ufbx_open_file_fn(void* user, ufbx_stream* stream,
  const char* path, size_t path_len, const ufbx_open_file_info* info);
...
typedef struct ufbx_close_memory_cb {
  ...
  UFBX_CALLBACK_IMPL(ufbx_close_memory_cb, ufbx_close_memory_fn, void,
    (void* user, void* data, size_t data_size), (data, data_size))
...
// NOTE: You must compile `ufbx.c` with `UFBX_ENABLE_ERROR_STACK` to enable the
// error stack.
...
UFBX_ENUM_TYPE(
  ufbx_error_type, UFBX_ERROR_TYPE, UFBX_ERROR_UNSUPPORTED_VERSION);
...
typedef struct ufbx_error {
  ...
  // NOTE: You must compile `ufbx.c` with `UFBX_ENABLE_ERROR_STACK` to enable
  // the error stack.
  uint32_t stack_size;
  ufbx_error_frame stack[UFBX_ERROR_STACK_MAX_DEPTH];

  // Additional error information, such as missing file filename.
  // `info` is a NULL-terminated UTF-8 string containing `info_length` bytes,
...
typedef ufbx_progress_result ufbx_progress_fn(
...
typedef struct ufbx_baked_quat {
  double time; // < Time of the keyframe, in seconds
  ufbx_quat
    value; // < Value at `time`, can be (spherically) linearly interpolated
  ufbx_baked_key_flags flags; // < Additional information about the keyframe
} ufbx_baked_quat;
...
typedef struct ufbx_baked_node {
  ...
  // Translation keys for the animation, maps to
  // `ufbx_node.local_transform.translation`.
...
typedef struct ufbx_baked_anim {
  ...
  // Some nodes may be missing if the specified animation does not transform
  // them. Conversely, some non-obviously animated nodes may be included as
  // exporters often may add dummy keyframes for objects.
...
// Passed to `ufbx_thread_pool_run_task()` from an user thread to run ufbx
// tasks. HINT: This context can store a user pointer via
...
typedef bool ufbx_thread_pool_init_fn(
  void* user, ufbx_thread_pool_context ctx, const ufbx_thread_pool_info* info);

// Run tasks `count` tasks in threads.
// You must call `ufbx_thread_pool_run_task()` with indices `[start_index,
// start_index + count)`. The threads are launched in batches indicated by
// `group`, see `UFBX_THREAD_GROUP_COUNT` for more information. Ideally, you
// should run all the task indices in parallel within each
// `ufbx_thread_pool_run_fn()` call.
typedef void ufbx_thread_pool_run_fn(void* user, ufbx_thread_pool_context ctx,
  uint32_t group, uint32_t start_index, uint32_t count);

// Wait for previous tasks spawned in `ufbx_thread_pool_run_fn()` to finish.
// `group` specifies the batch to wait for, `max_index` contains `start_index +
// count` from that group instance.
typedef void ufbx_thread_pool_wait_fn(
...
//
// Hypothetical example of calls, where `UFBX_THREAD_GROUP_COUNT=2` for
// simplicity:
//
//   run_fn(group=0, start_index=0, count=4)   -> t0 := threaded {
//   ufbx_thread_pool_run_task(0..3) } run_fn(group=1, start_index=4, count=10)
//   -> t1 := threaded { ufbx_thread_pool_run_task(4..10) } wait_fn(group=0,
//   max_index=4)             -> wait_threads(t0) run_fn(group=0,
//   start_index=10, count=15) -> t0 := threaded {
//   ufbx_thread_pool_run_task(10..14) } wait_fn(group=1, max_index=10) ->
//   wait_threads(t1) wait_fn(group=0, max_index=15)            ->
//   wait_threads(t0)
//
...
typedef struct ufbx_thread_opts {
  ...
  // Default: 32MB
  // NOTE: The actual used memory usage might be higher, if there are individual
  // tasks that rqeuire a high amount of memory.
  size_t memory_limit;
...
typedef struct ufbx_load_opts {
  ...
  // Blender converts PBR materials to legacy FBX Phong materials in a
  // deterministic way. If this setting is enabled, such materials will be read
  // as `UFBX_SHADER_BLENDER_PHONG`, which means ufbx will be able to parse
  ...
  // Animation keyframe clamp threshold, only applies to specific interpolation
  // modes.
...
UFBX_LIST_TYPE(
  ufbx_const_prop_override_desc_list, const ufbx_prop_override_desc);
...
typedef struct ufbx_anim_opts {
  ...
  // Corresponding to `ufbx_scene.anim_layers[]`, aka
  // `ufbx_anim_layer.typed_id`.
...
typedef enum ufbx_bake_step_handling UFBX_ENUM_REPR {
  ...
  // One millisecond default step duration, with potential extra slack for
  // converting to `float`.
  UFBX_BAKE_STEP_HANDLING_DEFAULT,

  // Use a custom interpolation duration for the constant step.
  // See `ufbx_bake_opts.step_custom_duration` and optionally
  // `ufbx_bake_opts.step_custom_epsilon`.
  UFBX_BAKE_STEP_HANDLING_CUSTOM_DURATION,

  // Stepped keyframes are represented as keyframes at the exact same time.
  // Use flags `UFBX_BAKED_KEY_STEP_LEFT` and `UFBX_BAKED_KEY_STEP_RIGHT` to
  // differentiate
  // between the primary key and edge limits.
  UFBX_BAKE_STEP_HANDLING_IDENTICAL_TIME,

  // Represent stepped keyframe times as the previous/next representable
  // `double` value.
  // Using this and robust linear interpolation will handle stepped tangents
  // correctly
  // without having to look at the key flags.
  // NOTE: Casting these values to `float` or otherwise modifying them can
  // collapse
...
UFBX_ENUM_TYPE(ufbx_bake_step_handling, UFBX_BAKE_STEP_HANDLING,
  UFBX_BAKE_STEP_HANDLING_IGNORE);
...
typedef struct ufbx_bake_opts {
  ...
  // Move the keyframe times to start from zero regardless of the animation
  // start time. For example, for an animation spanning between frames [30, 60]
  // will be moved to [0, 30] in the baked animation. NOTE: This is in general
  // not equivalent to subtracting `ufbx_anim.time_begin` from each keyframe, as
  // this trimming is done exactly using internal FBX ticks.
  ...
  // `time / (1.0 + step_custom_epsilon)` and `time * (1.0 +
  // step_custom_epsilon)`.
...
ufbx_abi ufbx_scene* ufbx_load_file(
  const char* filename, const ufbx_load_opts* opts, ufbx_error* error);
ufbx_abi ufbx_scene* ufbx_load_file_len(const char* filename,
  size_t filename_len, const ufbx_load_opts* opts, ufbx_error* error);
...
ufbx_abi ufbx_scene* ufbx_load_stdio(
  void* file, const ufbx_load_opts* opts, ufbx_error* error);
...
ufbx_abi ufbx_scene* ufbx_load_stream(
  const ufbx_stream* stream, const ufbx_load_opts* opts, ufbx_error* error);
...
ufbx_abi ufbx_scene* ufbx_load_stream_prefix(const ufbx_stream* stream,
  const void* prefix, size_t prefix_size, const ufbx_load_opts* opts,
  ufbx_error* error);
...
// terminator.
ufbx_abi size_t ufbx_format_error(
  char* dst, size_t dst_size, const ufbx_error* error);

// Query

// Find a property `name` from `props`, returns `NULL` if not found.
// Searches through `ufbx_props.defaults` as well.
ufbx_abi ufbx_prop* ufbx_find_prop_len(
  const ufbx_props* props, const char* name, size_t name_len);
...
ufbx_abi ufbx_real ufbx_find_real_len(
  const ufbx_props* props, const char* name, size_t name_len, ufbx_real def);
ufbx_abi ufbx_real ufbx_find_real(
  const ufbx_props* props, const char* name, ufbx_real def);
ufbx_abi ufbx_vec3 ufbx_find_vec3_len(
  const ufbx_props* props, const char* name, size_t name_len, ufbx_vec3 def);
ufbx_abi ufbx_vec3 ufbx_find_vec3(
  const ufbx_props* props, const char* name, ufbx_vec3 def);
ufbx_abi int64_t ufbx_find_int_len(
  const ufbx_props* props, const char* name, size_t name_len, int64_t def);
ufbx_abi int64_t ufbx_find_int(
  const ufbx_props* props, const char* name, int64_t def);
ufbx_abi bool ufbx_find_bool_len(
  const ufbx_props* props, const char* name, size_t name_len, bool def);
ufbx_abi bool ufbx_find_bool(
  const ufbx_props* props, const char* name, bool def);
ufbx_abi ufbx_string ufbx_find_string_len(
  const ufbx_props* props, const char* name, size_t name_len, ufbx_string def);
ufbx_abi ufbx_string ufbx_find_string(
  const ufbx_props* props, const char* name, ufbx_string def);
ufbx_abi ufbx_blob ufbx_find_blob_len(
  const ufbx_props* props, const char* name, size_t name_len, ufbx_blob def);
ufbx_abi ufbx_blob ufbx_find_blob(
  const ufbx_props* props, const char* name, ufbx_blob def);

// Find property in `props` with concatenated `parts[num_parts]`.
ufbx_abi ufbx_prop* ufbx_find_prop_concat(
  const ufbx_props* props, const ufbx_string* parts, size_t num_parts);

// Get an element connected to a property.
ufbx_abi ufbx_element* ufbx_get_prop_element(
  const ufbx_element* element, const ufbx_prop* prop, ufbx_element_type type);
...
ufbx_abi ufbx_element* ufbx_find_prop_element_len(const ufbx_element* element,
  const char* name, size_t name_len, ufbx_element_type type);
ufbx_abi ufbx_element* ufbx_find_prop_element(
  const ufbx_element* element, const char* name, ufbx_element_type type);
...
ufbx_abi ufbx_element* ufbx_find_element_len(const ufbx_scene* scene,
  ufbx_element_type type, const char* name, size_t name_len);
ufbx_abi ufbx_element* ufbx_find_element(
  const ufbx_scene* scene, ufbx_element_type type, const char* name);

// Find node in `scene` by `name` (shorthand for
// `ufbx_find_element(UFBX_ELEMENT_NODE)`).
ufbx_abi ufbx_node* ufbx_find_node_len(
  const ufbx_scene* scene, const char* name, size_t name_len);
...
ufbx_abi ufbx_anim_stack* ufbx_find_anim_stack_len(
  const ufbx_scene* scene, const char* name, size_t name_len);
ufbx_abi ufbx_anim_stack* ufbx_find_anim_stack(
  const ufbx_scene* scene, const char* name);

// Find a material in `scene` by `name` (shorthand for
// `ufbx_find_element(UFBX_ELEMENT_MATERIAL)`).
ufbx_abi ufbx_material* ufbx_find_material_len(
  const ufbx_scene* scene, const char* name, size_t name_len);
ufbx_abi ufbx_material* ufbx_find_material(
  const ufbx_scene* scene, const char* name);
...
ufbx_abi ufbx_anim_prop* ufbx_find_anim_prop_len(const ufbx_anim_layer* layer,
  const ufbx_element* element, const char* prop, size_t prop_len);
ufbx_abi ufbx_anim_prop* ufbx_find_anim_prop(
  const ufbx_anim_layer* layer, const ufbx_element* element, const char* prop);

// Find all animated properties of `element` in `layer`.
ufbx_abi ufbx_anim_prop_list ufbx_find_anim_props(
  const ufbx_anim_layer* layer, const ufbx_element* element);
...
ufbx_abi ufbx_matrix ufbx_get_compatible_matrix_for_normals(
...
ufbx_abi ptrdiff_t ufbx_inflate(void* dst, size_t dst_size,
  const ufbx_inflate_input* input, ufbx_inflate_retain* retain);
...
ufbx_unsafe ufbx_abi bool ufbx_open_file_ctx(ufbx_stream* stream,
  ufbx_open_file_context ctx, const char* path, size_t path_len,
  const ufbx_open_file_opts* opts, ufbx_error* error);
...
ufbx_unsafe ufbx_abi bool ufbx_open_memory_ctx(ufbx_stream* stream,
  ufbx_open_file_context ctx, const void* data, size_t data_size,
  const ufbx_open_memory_opts* opts, ufbx_error* error);

// Animation evaluation

// Evaluate a single animation `curve` at a `time`.
// Returns `default_value` only if `curve == NULL` or it has no keyframes.
ufbx_abi ufbx_real ufbx_evaluate_curve(
  const ufbx_anim_curve* curve, double time, ufbx_real default_value);
ufbx_abi ufbx_real ufbx_evaluate_curve_flags(const ufbx_anim_curve* curve,
  double time, ufbx_real default_value, uint32_t flags);

// Evaluate a value from bundled animation curves.
ufbx_abi ufbx_real ufbx_evaluate_anim_value_real(
  const ufbx_anim_value* anim_value, double time);
ufbx_abi ufbx_vec3 ufbx_evaluate_anim_value_vec3(
  const ufbx_anim_value* anim_value, double time);
ufbx_abi ufbx_real ufbx_evaluate_anim_value_real_flags(
  const ufbx_anim_value* anim_value, double time, uint32_t flags);
ufbx_abi ufbx_vec3 ufbx_evaluate_anim_value_vec3_flags(
  const ufbx_anim_value* anim_value, double time, uint32_t flags);
...
ufbx_abi ufbx_prop ufbx_evaluate_prop_len(const ufbx_anim* anim,
  const ufbx_element* element, const char* name, size_t name_len, double time);
ufbx_abi ufbx_prop ufbx_evaluate_prop(const ufbx_anim* anim,
  const ufbx_element* element, const char* name, double time);
ufbx_abi ufbx_prop ufbx_evaluate_prop_flags_len(const ufbx_anim* anim,
  const ufbx_element* element, const char* name, size_t name_len, double time,
  uint32_t flags);
ufbx_abi ufbx_prop ufbx_evaluate_prop_flags(const ufbx_anim* anim,
  const ufbx_element* element, const char* name, double time, uint32_t flags);
...
ufbx_abi ufbx_props ufbx_evaluate_props(const ufbx_anim* anim,
  const ufbx_element* element, double time, ufbx_prop* buffer,
  size_t buffer_size);
ufbx_abi ufbx_props ufbx_evaluate_props_flags(const ufbx_anim* anim,
  const ufbx_element* element, double time, ufbx_prop* buffer,
...
typedef enum ufbx_transform_flags UFBX_FLAG_REPR {
  ...
  // If `UFBX_TRANSFORM_FLAG_EXPLICIT_INCLUDES`: Evaluate
  // `ufbx_transform.translation`.
  UFBX_TRANSFORM_FLAG_INCLUDE_TRANSLATION = 0x10,
  // If `UFBX_TRANSFORM_FLAG_EXPLICIT_INCLUDES`: Evaluate
  // `ufbx_transform.rotation`.
  UFBX_TRANSFORM_FLAG_INCLUDE_ROTATION = 0x20,
  // If `UFBX_TRANSFORM_FLAG_EXPLICIT_INCLUDES`: Evaluate
  // `ufbx_transform.scale`.
...
// The returned transform is the local transform of the node (ie. relative to
// the parent), comparable to `ufbx_node.local_transform`.
ufbx_abi ufbx_transform ufbx_evaluate_transform(
  const ufbx_anim* anim, const ufbx_node* node, double time);
ufbx_abi ufbx_transform ufbx_evaluate_transform_flags(
  const ufbx_anim* anim, const ufbx_node* node, double time, uint32_t flags);

// Evaluate the blend shape weight of a blend channel.
// NOTE: Return value uses `1.0` for full weight, instead of `100.0` that the
// internal property `UFBX_Weight` uses.
ufbx_abi ufbx_real ufbx_evaluate_blend_weight(
  const ufbx_anim* anim, const ufbx_blend_channel* channel, double time);
ufbx_abi ufbx_real ufbx_evaluate_blend_weight_flags(const ufbx_anim* anim,
  const ufbx_blend_channel* channel, double time, uint32_t flags);
...
ufbx_abi ufbx_scene* ufbx_evaluate_scene(const ufbx_scene* scene,
  const ufbx_anim* anim, double time, const ufbx_evaluate_opts* opts,
  ufbx_error* error);
...
// overrides to evaluate the scene with different properties or local
// transforms.
ufbx_abi ufbx_anim* ufbx_create_anim(
  const ufbx_scene* scene, const ufbx_anim_opts* opts, ufbx_error* error);
...
ufbx_abi ufbx_baked_anim* ufbx_bake_anim(const ufbx_scene* scene,
  const ufbx_anim* anim, const ufbx_bake_opts* opts, ufbx_error* error);

ufbx_abi void ufbx_retain_baked_anim(ufbx_baked_anim* bake);
ufbx_abi void ufbx_free_baked_anim(ufbx_baked_anim* bake);

ufbx_abi ufbx_baked_node* ufbx_find_baked_node_by_typed_id(
  ufbx_baked_anim* bake, uint32_t typed_id);
ufbx_abi ufbx_baked_node* ufbx_find_baked_node(
  ufbx_baked_anim* bake, ufbx_node* node);

ufbx_abi ufbx_baked_element* ufbx_find_baked_element_by_element_id(
  ufbx_baked_anim* bake, uint32_t element_id);
ufbx_abi ufbx_baked_element* ufbx_find_baked_element(
  ufbx_baked_anim* bake, ufbx_element* element);

// Evaluate baked animation `keyframes` at `time`.
// Internally linearly interpolates between two adjacent keyframes.
// Handles stepped tangents cleanly, which is not strictly necessary for custom
// interpolation.
ufbx_abi ufbx_vec3 ufbx_evaluate_baked_vec3(
  ufbx_baked_vec3_list keyframes, double time);

// Evaluate baked animation `keyframes` at `time`.
// Internally spherically interpolates (`ufbx_quat_slerp()`) between two
// adjacent keyframes. Handles stepped tangents cleanly, which is not strictly
// necessary for custom interpolation.
ufbx_abi ufbx_quat ufbx_evaluate_baked_quat(
  ufbx_baked_quat_list keyframes, double time);

// Poses

// Retrieve the bone pose for `node`.
// Returns `NULL` if the pose does not contain `node`.
ufbx_abi ufbx_bone_pose* ufbx_get_bone_pose(
  const ufbx_pose* pose, const ufbx_node* node);

// Materials

// Find a texture for a given material FBX property.
ufbx_abi ufbx_texture* ufbx_find_prop_texture_len(
  const ufbx_material* material, const char* name, size_t name_len);
ufbx_abi ufbx_texture* ufbx_find_prop_texture(
  const ufbx_material* material, const char* name);

// Find a texture for a given shader property.
ufbx_abi ufbx_string ufbx_find_shader_prop_len(
  const ufbx_shader* shader, const char* name, size_t name_len);
ufbx_abi ufbx_string ufbx_find_shader_prop(
  const ufbx_shader* shader, const char* name);

// Map from a shader property to material property.
ufbx_abi ufbx_shader_prop_binding_list ufbx_find_shader_prop_bindings_len(
  const ufbx_shader* shader, const char* name, size_t name_len);
ufbx_abi ufbx_shader_prop_binding_list ufbx_find_shader_prop_bindings(
  const ufbx_shader* shader, const char* name);

// Find an input in a shader texture.
ufbx_abi ufbx_shader_texture_input* ufbx_find_shader_texture_input_len(
  const ufbx_shader_texture* shader, const char* name, size_t name_len);
ufbx_abi ufbx_shader_texture_input* ufbx_find_shader_texture_input(
  const ufbx_shader_texture* shader, const char* name);
...
ufbx_abi ufbx_matrix ufbx_matrix_mul(
  const ufbx_matrix* a, const ufbx_matrix* b);
...
// NOTE: You must normalize the normals after transforming them with this
// matrix, eg. using `ufbx_vec3_normalize()`. NOTE: This function flips the
// normals if the determinant is negative.
...
ufbx_abi ufbx_matrix ufbx_catch_get_skin_vertex_matrix(ufbx_panic* panic,
  const ufbx_skin_deformer* skin, size_t vertex, const ufbx_matrix* fallback);
ufbx_inline ufbx_matrix ufbx_get_skin_vertex_matrix(
  const ufbx_skin_deformer* skin, size_t vertex, const ufbx_matrix* fallback)
{
...
ufbx_abi uint32_t ufbx_get_blend_shape_offset_index(
...
ufbx_abi ufbx_vec3 ufbx_get_blend_vertex_offset(
  const ufbx_blend_deformer* blend, size_t vertex);
...
ufbx_abi void ufbx_add_blend_shape_vertex_offsets(const ufbx_blend_shape* shape,
  ufbx_vec3* vertices, size_t num_vertices, ufbx_real weight);
...
ufbx_abi size_t ufbx_evaluate_nurbs_basis(const ufbx_nurbs_basis* basis,
  ufbx_real u, ufbx_real* weights, size_t num_weights, ufbx_real* derivatives,
  size_t num_derivatives);

// Evaluate a point on a NURBS curve given the parameter `u`.
ufbx_abi ufbx_curve_point ufbx_evaluate_nurbs_curve(
  const ufbx_nurbs_curve* curve, ufbx_real u);
...
ufbx_abi ufbx_line_curve* ufbx_tessellate_nurbs_curve(
  const ufbx_nurbs_curve* curve, const ufbx_tessellate_curve_opts* opts,
  ufbx_error* error);

// Tessellate a NURBS surface into a mesh.
ufbx_abi ufbx_mesh* ufbx_tessellate_nurbs_surface(
  const ufbx_nurbs_surface* surface, const ufbx_tessellate_surface_opts* opts,
  ufbx_error* error);
...
ufbx_abi uint32_t ufbx_catch_triangulate_face(ufbx_panic* panic,
  uint32_t* indices, size_t num_indices, const ufbx_mesh* mesh, ufbx_face face);
ufbx_abi uint32_t ufbx_triangulate_face(
  uint32_t* indices, size_t num_indices, const ufbx_mesh* mesh, ufbx_face face);
...
ufbx_abi void ufbx_catch_compute_topology(ufbx_panic* panic,
  const ufbx_mesh* mesh, ufbx_topo_edge* topo, size_t num_topo);
ufbx_abi void ufbx_compute_topology(
  const ufbx_mesh* mesh, ufbx_topo_edge* topo, size_t num_topo);
...
ufbx_abi uint32_t ufbx_catch_topo_next_vertex_edge(ufbx_panic* panic,
  const ufbx_topo_edge* topo, size_t num_topo, uint32_t index);
ufbx_abi uint32_t ufbx_topo_next_vertex_edge(
  const ufbx_topo_edge* topo, size_t num_topo, uint32_t index);

// Get the previous half-edge in `topo`.
ufbx_abi uint32_t ufbx_catch_topo_prev_vertex_edge(ufbx_panic* panic,
  const ufbx_topo_edge* topo, size_t num_topo, uint32_t index);
ufbx_abi uint32_t ufbx_topo_prev_vertex_edge(
  const ufbx_topo_edge* topo, size_t num_topo, uint32_t index);
...
ufbx_abi size_t ufbx_generate_normal_mapping(const ufbx_mesh* mesh,
  const ufbx_topo_edge* topo, size_t num_topo, uint32_t* normal_indices,
  size_t num_normal_indices, bool assume_smooth);

// Compute normals given normal indices.
// You can use `ufbx_generate_normal_mapping()` to generate the normal indices.
ufbx_abi void ufbx_catch_compute_normals(ufbx_panic* panic,
  const ufbx_mesh* mesh, const ufbx_vertex_vec3* positions,
  const uint32_t* normal_indices, size_t num_normal_indices, ufbx_vec3* normals,
  size_t num_normals);
ufbx_abi void ufbx_compute_normals(const ufbx_mesh* mesh,
  const ufbx_vertex_vec3* positions, const uint32_t* normal_indices,
  size_t num_normal_indices, ufbx_vec3* normals, size_t num_normals);
...
ufbx_abi ufbx_mesh* ufbx_subdivide_mesh(const ufbx_mesh* mesh, size_t level,
  const ufbx_subdivide_opts* opts, ufbx_error* error);

// Free a mesh returned from `ufbx_subdivide_mesh()` or
// `ufbx_tessellate_nurbs_surface()`.
...
ufbx_abi ufbx_geometry_cache* ufbx_load_geometry_cache(const char* filename,
  const ufbx_geometry_cache_opts* opts, ufbx_error* error);
ufbx_abi ufbx_geometry_cache* ufbx_load_geometry_cache_len(const char* filename,
  size_t filename_len, const ufbx_geometry_cache_opts* opts, ufbx_error* error);
...
ufbx_abi size_t ufbx_read_geometry_cache_real(const ufbx_cache_frame* frame,
  ufbx_real* data, size_t num_data, const ufbx_geometry_cache_data_opts* opts);
ufbx_abi size_t ufbx_read_geometry_cache_vec3(const ufbx_cache_frame* frame,
  ufbx_vec3* data, size_t num_data, const ufbx_geometry_cache_data_opts* opts);
// Sample the a geometry cache channel, linearly blending between adjacent
// frames.
...
ufbx_abi ufbx_dom_node* ufbx_dom_find_len(
  const ufbx_dom_node* parent, const char* name, size_t name_len);
ufbx_abi ufbx_dom_node* ufbx_dom_find(
  const ufbx_dom_node* parent, const char* name);

// Utility

// Generate an index buffer for a flat vertex buffer.
// `streams` specifies one or more vertex data arrays, each stream must contain
// `num_indices` vertices. This function compacts the data within `streams`
...
ufbx_abi size_t ufbx_generate_indices(const ufbx_vertex_stream* streams,
  size_t num_streams, uint32_t* indices, size_t num_indices,
  const ufbx_allocator_opts* allocator, ufbx_error* error);

// Thread pool

// Run a single thread pool task.
// See `ufbx_thread_pool_run_fn` for more information.
ufbx_unsafe ufbx_abi void ufbx_thread_pool_run_task(
  ufbx_thread_pool_context ctx, uint32_t index);

// Get or set an arbitrary user pointer for the thread pool context.
// `ufbx_thread_pool_get_user_ptr()` returns `NULL` if unset.
ufbx_unsafe ufbx_abi void ufbx_thread_pool_set_user_ptr(
  ufbx_thread_pool_context ctx, void* user_ptr);
ufbx_unsafe ufbx_abi void* ufbx_thread_pool_get_user_ptr(
  ufbx_thread_pool_context ctx);

// -- Inline API

// Utility functions for reading geometry data for a single index.
ufbx_abi ufbx_real ufbx_catch_get_vertex_real(
  ufbx_panic* panic, const ufbx_vertex_real* v, size_t index);
ufbx_abi ufbx_vec2 ufbx_catch_get_vertex_vec2(
  ufbx_panic* panic, const ufbx_vertex_vec2* v, size_t index);
ufbx_abi ufbx_vec3 ufbx_catch_get_vertex_vec3(
  ufbx_panic* panic, const ufbx_vertex_vec3* v, size_t index);
ufbx_abi ufbx_vec4 ufbx_catch_get_vertex_vec4(
  ufbx_panic* panic, const ufbx_vertex_vec4* v, size_t index);

// Utility functions for reading geometry data for a single index.
ufbx_inline ufbx_real ufbx_get_vertex_real(
  const ufbx_vertex_real* v, size_t index)
{
  ufbx_assert(index < v->indices.count);
  return v->values.data[(int32_t)v->indices.data[index]];
}
ufbx_inline ufbx_vec2 ufbx_get_vertex_vec2(
  const ufbx_vertex_vec2* v, size_t index)
{
  ufbx_assert(index < v->indices.count);
  return v->values.data[(int32_t)v->indices.data[index]];
}
ufbx_inline ufbx_vec3 ufbx_get_vertex_vec3(
  const ufbx_vertex_vec3* v, size_t index)
{
  ufbx_assert(index < v->indices.count);
  return v->values.data[(int32_t)v->indices.data[index]];
}
ufbx_inline ufbx_vec4 ufbx_get_vertex_vec4(
  const ufbx_vertex_vec4* v, size_t index)
{
  ufbx_assert(index < v->indices.count);
  return v->values.data[(int32_t)v->indices.data[index]];
}

ufbx_abi ufbx_real ufbx_catch_get_vertex_w_vec3(
  ufbx_panic* panic, const ufbx_vertex_vec3* v, size_t index);
ufbx_inline ufbx_real ufbx_get_vertex_w_vec3(
  const ufbx_vertex_vec3* v, size_t index)
{
  ufbx_assert(index < v->indices.count);
  return v->values_w.count > 0
    ? v->values_w.data[(int32_t)v->indices.data[index]]
    : 0.0f;
}
...
ufbx_abi ufbx_nurbs_trim_surface* ufbx_as_nurbs_trim_surface(
  const ufbx_element* element);
ufbx_abi ufbx_nurbs_trim_boundary* ufbx_as_nurbs_trim_boundary(
  const ufbx_element* element);
ufbx_abi ufbx_procedural_geometry* ufbx_as_procedural_geometry(
  const ufbx_element* element);
ufbx_abi ufbx_stereo_camera* ufbx_as_stereo_camera(const ufbx_element* element);
ufbx_abi ufbx_camera_switcher* ufbx_as_camera_switcher(
  const ufbx_element* element);
...
ufbx_abi ufbx_blend_deformer* ufbx_as_blend_deformer(
  const ufbx_element* element);
...
ufbx_abi ufbx_cache_deformer* ufbx_as_cache_deformer(
  const ufbx_element* element);
...
ufbx_abi ufbx_shader_binding* ufbx_as_shader_binding(
  const ufbx_element* element);
...
ufbx_abi ufbx_selection_node* ufbx_as_selection_node(
  const ufbx_element* element);
...
ufbx_abi ufbx_metadata_object* ufbx_as_metadata_object(
  const ufbx_element* element);
...
ufbx_inline ufbx_scene* ufbx_load_file(
  ufbx_string_view filename, const ufbx_load_opts* opts, ufbx_error* error)
{
  return ufbx_load_file_len(filename.data, filename.length, opts, error);
}
ufbx_inline ufbx_prop* ufbx_find_prop(
  const ufbx_props* props, ufbx_string_view name)
{
  return ufbx_find_prop_len(props, name.data, name.length);
}
ufbx_inline ufbx_real ufbx_find_real(
  const ufbx_props* props, ufbx_string_view name, ufbx_real def)
{
  return ufbx_find_real_len(props, name.data, name.length, def);
}
ufbx_inline ufbx_vec3 ufbx_find_vec3(
  const ufbx_props* props, ufbx_string_view name, ufbx_vec3 def)
{
  return ufbx_find_vec3_len(props, name.data, name.length, def);
}
ufbx_inline int64_t ufbx_find_int(
  const ufbx_props* props, ufbx_string_view name, int64_t def)
{
  return ufbx_find_int_len(props, name.data, name.length, def);
}
ufbx_inline bool ufbx_find_bool(
  const ufbx_props* props, ufbx_string_view name, bool def)
{
  return ufbx_find_bool_len(props, name.data, name.length, def);
}
ufbx_inline ufbx_string ufbx_find_string(
  const ufbx_props* props, ufbx_string_view name, ufbx_string def)
{
  return ufbx_find_string_len(props, name.data, name.length, def);
}
ufbx_inline ufbx_blob ufbx_find_blob(
  const ufbx_props* props, ufbx_string_view name, ufbx_blob def)
{
  return ufbx_find_blob_len(props, name.data, name.length, def);
}
ufbx_inline ufbx_element* ufbx_find_prop_element(
...
ufbx_inline ufbx_element* ufbx_find_element(
...
ufbx_inline ufbx_shader_texture_input* ufbx_find_shader_texture_input(
  const ufbx_shader_texture* shader, ufbx_string_view name)
{
  return ufbx_find_shader_texture_input_len(shader, name.data, name.length);
}
ufbx_inline ufbx_geometry_cache* ufbx_load_geometry_cache(
  ufbx_string_view filename, const ufbx_geometry_cache_opts* opts,
  ufbx_error* error)
{
  return ufbx_load_geometry_cache_len(
    filename.data, filename.length, opts, error);
}
ufbx_inline ufbx_dom_node* ufbx_dom_find(
...
public:
  ...
  {
    static_assert(
      ufbx_type_traits<T>::valid, "ufbx_deleter() unsupported for type");
...
template <typename T> class ufbx_unique_ptr {
  ...
  static_assert(
    ufbx_type_traits<T>::valid, "ufbx_unique_ptr unsupported for type");

public:
  ufbx_unique_ptr() noexcept
    : ptr(nullptr)
  {
  }
  explicit ufbx_unique_ptr(T* ptr_) noexcept
    : ptr(ptr_)
  {
  }
  ufbx_unique_ptr(ufbx_unique_ptr&& ref) noexcept
    : ptr(ref.ptr)
  {
    ref.ptr = nullptr;
  }
...
template <typename T> class ufbx_shared_ptr {
  ...
  using traits = ufbx_type_traits<T>;
  static_assert(
    ufbx_type_traits<T>::valid, "ufbx_shared_ptr unsupported for type");

public:
  ufbx_shared_ptr() noexcept
    : ptr(nullptr)
  {
  }
  explicit ufbx_shared_ptr(T* ptr_) noexcept
    : ptr(ptr_)
  {
  }
  ufbx_shared_ptr(const ufbx_shared_ptr& ref) noexcept
    : ptr(ref.ptr)
  {
    traits::retain(ref.ptr);
  }
  ufbx_shared_ptr(ufbx_shared_ptr&& ref) noexcept
    : ptr(ref.ptr)
  {
    ref.ptr = nullptr;
  }
