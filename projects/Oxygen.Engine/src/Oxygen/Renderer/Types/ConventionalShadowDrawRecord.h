...
struct alignas(16) ConventionalShadowDrawRecord {
  ...
  engine::PassMask partition_pass_mask {};
...
{
  return engine::HasAnyDrawPrimitiveFlag(
    record.primitive_flags, engine::DrawPrimitiveFlagBits::kStaticShadowCaster);
}
...
{
  return engine::HasAnyDrawPrimitiveFlag(
    record.primitive_flags, engine::DrawPrimitiveFlagBits::kMainViewVisible);
}
