  ...
  const GpuSkyAtmosphereParams& params) -> CachedParams
{
  return CachedParams {
    ...
    .absorption_layer_width_m = params.absorption_layer_width_m,
    .absorption_term_below = params.absorption_term_below,
    .absorption_term_above = params.absorption_term_above,
