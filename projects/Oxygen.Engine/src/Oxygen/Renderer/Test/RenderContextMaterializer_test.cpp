...
using oxygen::engine::internal::CoreShaderInputsInput;
using oxygen::engine::internal::FrameSessionInput;
using oxygen::engine::internal::OutputTargetInput;
using oxygen::engine::internal::PreparedFrameInput;
using oxygen::engine::internal::RenderContextMaterializer;
using oxygen::engine::internal::ResolvedViewInput;
using oxygen::engine::internal::SinglePassHarnessStaging;
  ...
  MaterializeSinglePassAcceptsExplicitCoreShaderInputsWithoutResolvedView)
{
  ...
  staging.core_shader_inputs = CoreShaderInputsInput {
    .view_id = ViewId { 77U },
    .value = oxygen::engine::ViewConstants {},
  };
