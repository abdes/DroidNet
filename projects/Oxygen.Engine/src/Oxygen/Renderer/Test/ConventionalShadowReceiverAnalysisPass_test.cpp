...
protected:
    ...
    -> std::shared_ptr<Framebuffer>
  {
    ...
    CHECK_NOTNULL_F(
      color.get(), "Failed to create receiver-analysis harness framebuffer");
    ...
    CHECK_NOTNULL_F(framebuffer.get(),
      "Failed to create receiver-analysis harness framebuffer");
    return framebuffer;
  }
  ...
  ProducesSampleDrivenReceiverBoundsTighterThanFullCascadeFit)
{
  ...
  auto framebuffer = MakeHarnessFramebuffer("receiver-analysis");
