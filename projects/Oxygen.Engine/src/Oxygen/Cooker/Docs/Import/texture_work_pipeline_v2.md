...
- `src/Oxygen/Cooker/Import/Async/Pipelines/BufferPipeline.*` (pipeline pattern)
- `src/Oxygen/Cooker/Import/Async/Emitters/TextureEmitter.*` (I/O + indices)
- `src/Oxygen/Cooker/Import/TextureCooker.*` (sync cooking implementation)
