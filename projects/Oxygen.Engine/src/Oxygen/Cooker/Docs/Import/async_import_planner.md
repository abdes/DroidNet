...
- [src/Oxygen/Cooker/Import/Internal/ImportPlanner.h](src/Oxygen/Cooker/Import/Internal/ImportPlanner.h)
- [src/Oxygen/Cooker/Import/Internal/ImportPlanner.cpp](src/Oxygen/Cooker/Import/Internal/ImportPlanner.cpp)
...
- `RegisterPipeline<Pipeline>()` requires `Pipeline` to satisfy
  `ImportPipeline` (see
  [src/Oxygen/Cooker/Import/Internal/ImportPipeline.h](src/Oxygen/Cooker/Import/Internal/ImportPipeline.h)).
