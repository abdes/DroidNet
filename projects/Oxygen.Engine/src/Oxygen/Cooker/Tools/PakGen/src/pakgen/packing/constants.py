...
PHYSICS_RESOURCE_DESC_SIZE: Final = 45
PHYSICS_MATERIAL_ASSET_DESC_SIZE: Final = 121
COLLISION_SHAPE_ASSET_DESC_SIZE: Final = 265

RIGID_BODY_BINDING_RECORD_SIZE: Final = 122
CHARACTER_BINDING_RECORD_SIZE: Final = 82
SOFT_BODY_BINDING_RECORD_SIZE: Final = 89
JOINT_BINDING_RECORD_SIZE: Final = 28
COLLIDER_BINDING_RECORD_SIZE: Final = 46
VEHICLE_BINDING_RECORD_SIZE: Final = 20
...
RESOURCE_ENTRY_SIZES: Final = {
    ...
    "audio": 32,
    "script": 23,
    "physics": 45,  # PhysicsResourceDesc
}

PHYSICS_RESOURCE_ENTRY_SIZE: Final = 45
