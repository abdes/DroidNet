...
PHYSICS_RESOURCE_DESC_SIZE: Final = 48
PHYSICS_MATERIAL_ASSET_DESC_SIZE: Final = 128
COLLISION_SHAPE_ASSET_DESC_SIZE: Final = 268

RIGID_BODY_BINDING_RECORD_SIZE: Final = 128
COLLIDER_BINDING_RECORD_SIZE: Final = 56
CHARACTER_BINDING_RECORD_SIZE: Final = 96
SOFT_BODY_BINDING_RECORD_SIZE: Final = 96
JOINT_BINDING_RECORD_SIZE: Final = 32
VEHICLE_BINDING_RECORD_SIZE: Final = 32
VEHICLE_WHEEL_BINDING_RECORD_SIZE: Final = 16
...
RESOURCE_ENTRY_SIZES: Final = {
    ...
    "audio": 32,
    "script": 32,
    "physics": 48,  # PhysicsResourceDesc
}

PHYSICS_RESOURCE_ENTRY_SIZE: Final = 48
