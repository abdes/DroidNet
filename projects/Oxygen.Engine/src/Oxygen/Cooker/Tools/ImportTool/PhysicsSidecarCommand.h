...
class PhysicsSidecarCommand final : public ImportCommand {
public:
  explicit PhysicsSidecarCommand(const GlobalOptions* global_options)
...
public:
  PhysicsSidecarImportSettings options_ {};
};
