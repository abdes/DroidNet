...
**Program Name:** `Oxygen.Cooker.ImportTool`
...
Oxygen.Cooker.ImportTool texture input.png --output ./Cooked --intent albedo

# Normal map with custom mip settings
Oxygen.Cooker.ImportTool texture normal.png -o ./Cooked \
  --intent normal --mip-filter lanczos --bc7-quality high

# HDR environment map with cubemap conversion
Oxygen.Cooker.ImportTool texture env.exr -o ./Cooked \
  --intent hdr-env --equirect-to-cube --cube-face-size 1024

# Using preset with override
Oxygen.Cooker.ImportTool texture albedo.png -o ./Cooked \
...
Oxygen.Cooker.ImportTool batch import-manifest.json --output ./Cooked

# Dry run for validation
Oxygen.Cooker.ImportTool batch import-manifest.json --dry-run

# CI mode: no TUI, JSON logs, fail fast
Oxygen.Cooker.ImportTool batch import-manifest.json \
...
Oxygen.Cooker.ImportTool fbx scene.fbx --output ./Cooked

# Geometry only, normalized units
Oxygen.Cooker.ImportTool fbx mesh.fbx -o ./Cooked \
  --no-import-textures --no-import-materials --unit-policy normalize

# Custom unit scale with transform baking disabled
Oxygen.Cooker.ImportTool fbx scene.fbx -o ./Cooked \
...
```bash
# Full glTF import
Oxygen.Cooker.ImportTool gltf model.gltf --output ./Cooked

# GLB with custom processing
Oxygen.Cooker.ImportTool gltf model.glb -o ./Cooked \
