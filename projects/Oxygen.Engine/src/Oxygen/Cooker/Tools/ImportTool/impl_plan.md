...
1. Read the specification in [src/Oxygen/Cooker/Tools/ImportTool/README.md](src/Oxygen/Cooker/Tools/ImportTool/README.md).
2. Identify the current implementation files:
   - [src/Oxygen/Cooker/Tools/ImportTool/TextureCommand.cpp](src/Oxygen/Cooker/Tools/ImportTool/TextureCommand.cpp)
   - [src/Oxygen/Cooker/Tools/ImportTool/BatchCommand.cpp](src/Oxygen/Cooker/Tools/ImportTool/BatchCommand.cpp)
   - [src/Oxygen/Cooker/Tools/ImportTool/ImportRunner.cpp](src/Oxygen/Cooker/Tools/ImportTool/ImportRunner.cpp)
3. Review relevant modules for mapping and constraints:
   - [src/Oxygen/Cooker/Import/ImportRequest.h](src/Oxygen/Cooker/Import/ImportRequest.h)
   ...
   - [src/Oxygen/Cooker/Import/ImportManifest_schema.h](src/Oxygen/Cooker/Import/ImportManifest_schema.h)
