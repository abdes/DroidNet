...
public:
  ...
  /*!
    ...
    name
  */
  OXGN_COOK_API void Add(TextureSource source);
  ...
  */
  OXGN_COOK_API void AddArrayLayer(
  ...
  /*!
    ...
    @param source_id Diagnostic identifier for error messages
  */
  OXGN_COOK_API void AddCubeFace(
  ...
  /*!
    ...
    @param source_id   Diagnostic identifier for error messages
  */
  OXGN_COOK_API void AddDepthSlice(
  ...
  /*!
    ...
    @param source_id   Diagnostic identifier for error messages
  */
  OXGN_COOK_API void AddMipLevel(uint16_t array_layer, uint16_t mip_level,
  ...
  OXGN_COOK_API void Clear() noexcept;
  ...
  */
  OXGN_COOK_NDAPI auto GetSource(size_t index) const -> const TextureSource&;
...
*/
OXGN_COOK_NDAPI auto ComputeCubeDirection(
...
/*!
  ...
  ```
*/
OXGN_COOK_NDAPI auto AssembleCubeFromFaces(
...
/*!
  ...
  ```
*/
OXGN_COOK_NDAPI auto ConvertEquirectangularToCube(
...
OXGN_COOK_NDAPI auto to_string(CubeMapImageLayout layout) -> const char*;
...
*/
OXGN_COOK_NDAPI auto DetectCubeMapLayout(uint32_t width,
...
*/
OXGN_COOK_NDAPI auto DetectCubeMapLayout(const ScratchImage& image) noexcept
...
*/
OXGN_COOK_NDAPI auto ExtractCubeFacesFromLayout(
