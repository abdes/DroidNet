...
OXGN_COOK_NDAPI auto to_string(TexturePreset value) -> const char*;
...
*/
OXGN_COOK_NDAPI auto GetPresetMetadata(TexturePreset preset) noexcept
...
*/
OXGN_COOK_API void ApplyPreset(
...
*/
OXGN_COOK_NDAPI auto MakeDescFromPreset(TexturePreset preset) noexcept
  -> TextureImportDesc;
