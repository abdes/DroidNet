...
//! Pipeline for scripting-sidecar import execution.
class ScriptingSidecarImportPipeline final : public Object {
  OXYGEN_TYPED(ScriptingSidecarImportPipeline)
public:
...
static_assert(ImportPipeline<ScriptingSidecarImportPipeline>);
