...
//! Pipeline for physics material descriptor payload construction.
class PhysicsMaterialImportPipeline final : public Object {
  OXYGEN_TYPED(PhysicsMaterialImportPipeline)
public:
...
static_assert(ImportPipeline<PhysicsMaterialImportPipeline>);
