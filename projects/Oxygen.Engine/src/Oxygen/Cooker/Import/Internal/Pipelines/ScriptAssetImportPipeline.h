...
//! Pipeline for script-asset import execution.
class ScriptAssetImportPipeline final : public Object {
  OXYGEN_TYPED(ScriptAssetImportPipeline)
public:
  ...
  OXYGEN_MAKE_NON_COPYABLE(ScriptAssetImportPipeline)
  OXYGEN_MAKE_NON_MOVABLE(ScriptAssetImportPipeline)
...
static_assert(ImportPipeline<ScriptAssetImportPipeline>);
