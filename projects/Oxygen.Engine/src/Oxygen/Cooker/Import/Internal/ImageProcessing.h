...
namespace image::color {
  ...
  */
  OXGN_COOK_NDAPI auto SrgbToLinear(float srgb) noexcept -> float;
  ...
  */
  OXGN_COOK_NDAPI auto LinearToSrgb(float linear) noexcept -> float;
  ...
  */
  OXGN_COOK_NDAPI auto SrgbToLinear(std::array<float, 4> rgba) noexcept
    -> std::array<float, 4>;
  ...
  */
  OXGN_COOK_NDAPI auto LinearToSrgb(std::array<float, 4> rgba) noexcept
    -> std::array<float, 4>;
  ...
  */
  OXGN_COOK_API void ConvertSrgbToLinear(ScratchImage& image);
  ...
  /*!
    ...
    @param image Image to convert (modified in-place)
  */
  OXGN_COOK_API void ConvertLinearToSrgb(ScratchImage& image);
...
namespace image::hdr {
  ...
  */
  OXGN_COOK_NDAPI auto ApplyExposure(
  ...
  */
  OXGN_COOK_NDAPI auto AcesTonemap(std::array<float, 4> rgba) noexcept
    -> std::array<float, 4>;
  ...
  */
  OXGN_COOK_NDAPI auto BakeToLdr(const ScratchImage& hdr_image, float exposure)
    -> ScratchImage;
...
namespace image::mip {
  ...
  /*!
    ...
    @return I0(x)
  */
  OXGN_COOK_NDAPI auto BesselI0(float x) noexcept -> float;
  ...
  /*!
    ...
    @return Window value
  */
  OXGN_COOK_NDAPI auto KaiserWindow(float x, float alpha) noexcept -> float;
  ...
  /*!
    ...
    @return Kernel value
  */
  OXGN_COOK_NDAPI auto LanczosKernel(float x, int a) noexcept -> float;
  ...
  */
  OXGN_COOK_NDAPI auto ComputeMipCount(uint32_t width, uint32_t height) noexcept
    -> uint32_t;
  ...
  */
  OXGN_COOK_NDAPI auto GenerateChain2D(const ScratchImage& source,
  ...
  /*!
    ...
    @return New ScratchImage with mip chain
  */
  OXGN_COOK_NDAPI auto GenerateChain3D(const ScratchImage& source,
    MipFilter filter, ColorSpace color_space, uint32_t target_mip_levels = 0)
    -> ScratchImage;
...
namespace image::content {
  ...
  */
  OXGN_COOK_NDAPI auto RenormalizeNormal(std::array<float, 4> rgba) noexcept
    -> std::array<float, 4>;
  ...
  /*!
    ...
    @return New ScratchImage with mip chain
  */
  OXGN_COOK_NDAPI auto GenerateNormalMapMips(const ScratchImage& source,
  ...
  */
  OXGN_COOK_API void FlipNormalGreen(ScratchImage& image);
