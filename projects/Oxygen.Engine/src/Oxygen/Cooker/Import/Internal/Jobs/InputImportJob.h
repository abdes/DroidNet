...
//! Standalone input import job.
/*!
 Imports one input JSON source via InputImportPipeline.
*/
class InputImportJob final : public ImportJob {
  OXYGEN_TYPED(InputImportJob)
public:
