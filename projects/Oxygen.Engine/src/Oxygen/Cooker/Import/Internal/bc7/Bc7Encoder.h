...
struct Bc7EncoderParams {
  ...
  OXGN_COOK_NDAPI static auto Fast() noexcept -> Bc7EncoderParams;

  //! Create parameters for default (balanced) encoding.
  OXGN_COOK_NDAPI static auto Default() noexcept -> Bc7EncoderParams;

  //! Create parameters for high quality encoding.
  OXGN_COOK_NDAPI static auto High() noexcept -> Bc7EncoderParams;

  //! Create parameters from a Bc7Quality tier.
  OXGN_COOK_NDAPI static auto FromQuality(Bc7Quality quality) noexcept
    -> Bc7EncoderParams;
};
...
*/
OXGN_COOK_API void InitializeEncoder();
...
*/
OXGN_COOK_API auto EncodeBlock(std::span<const std::byte, 64> pixels_rgba8,
...
*/
OXGN_COOK_NDAPI auto EncodeSurface(
...
*/
OXGN_COOK_NDAPI auto EncodeTexture(
...
OXGN_COOK_NDAPI auto EncodeTexture(const ScratchImage& source,
