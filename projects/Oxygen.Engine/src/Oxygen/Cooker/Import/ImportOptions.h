...
OXGN_COOK_API auto to_string(UnitNormalizationPolicy value) -> std::string;
...
OXGN_COOK_API auto to_string(ImportContentFlags value) -> std::string;
...
OXGN_COOK_API auto to_string(GeometryAttributePolicy value) -> std::string;
...
OXGN_COOK_API auto to_string(NodePruningPolicy value) -> std::string;
