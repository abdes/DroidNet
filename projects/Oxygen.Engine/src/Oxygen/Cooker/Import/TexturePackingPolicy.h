...
public:
  ...
  OXGN_COOK_NDAPI static auto Instance() noexcept -> const D3D12PackingPolicy&;
...
public:
  //! Returns the singleton instance.
  OXGN_COOK_NDAPI static auto Instance() noexcept -> const TightPackedPolicy&;
...
*/
OXGN_COOK_NDAPI auto ComputeBytesPerPixelOrBlock(Format format) noexcept
  -> uint32_t;
...
*/
OXGN_COOK_NDAPI auto ComputeBlockDimension(Format format) noexcept -> uint32_t;
...
*/
OXGN_COOK_NDAPI auto ComputeRowBytes(uint32_t width, Format format) noexcept
  -> uint32_t;
...
*/
OXGN_COOK_NDAPI auto ComputeSurfaceBytes(
...
*/
OXGN_COOK_NDAPI auto ComputeSubresourceLayouts(const ScratchImageMeta& meta,
...
*/
OXGN_COOK_NDAPI auto ComputeTotalPayloadSize(
