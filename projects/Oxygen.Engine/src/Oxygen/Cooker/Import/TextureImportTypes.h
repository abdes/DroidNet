...
OXGN_COOK_NDAPI auto to_string(TextureIntent value) -> const char*;
...
OXGN_COOK_NDAPI auto to_string(MipPolicy value) -> const char*;
...
OXGN_COOK_NDAPI auto to_string(MipFilter value) -> const char*;
...
OXGN_COOK_NDAPI auto to_string(Bc7Quality value) -> const char*;
...
OXGN_COOK_NDAPI auto to_string(HdrHandling value) -> const char*;
