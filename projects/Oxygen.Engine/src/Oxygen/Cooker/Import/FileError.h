...
struct FileErrorInfo {
  ...
  */
  OXGN_COOK_NDAPI auto ToString() const -> std::string;
...
*/
OXGN_COOK_NDAPI auto MapSystemError(std::error_code ec) -> FileError;
...
*/
OXGN_COOK_NDAPI auto MakeFileError(
...
*/
OXGN_COOK_NDAPI auto MakeFileError(const std::filesystem::path& path,
