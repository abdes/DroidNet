...
public:
  ...
  */
  OXGN_COOK_NDAPI static auto ComputeMipCount(
  ...
  */
  OXGN_COOK_NDAPI static auto Create(const ScratchImageMeta& meta)
    -> ScratchImage;
  ...
  */
  OXGN_COOK_NDAPI static auto CreateFromData(uint32_t width, uint32_t height,
  ...
  */
  OXGN_COOK_NDAPI auto GetImage(uint16_t array_layer, uint16_t mip_level) const
    -> ImageView;
  ...
  */
  OXGN_COOK_NDAPI auto GetMutablePixels(
