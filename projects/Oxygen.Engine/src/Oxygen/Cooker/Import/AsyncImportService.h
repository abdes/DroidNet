...
public:
  ...
  */
  OXGN_COOK_API explicit AsyncImportService(std::optional<Config> config = {});
  ...
  */
  OXGN_COOK_API ~AsyncImportService();
  ...
  */
  OXGN_COOK_NDAPI auto SubmitImport(ImportRequest request,
  ...
  */
  OXGN_COOK_NDAPI auto SubmitManifest(const ImportManifest& manifest,
  ...
  */
  OXGN_COOK_API auto RequestShutdown() const -> void;
  ...
  */
  OXGN_COOK_API auto Stop() const -> void;
  ...
  /*!
   ...
   during teardown).
  */
  OXGN_COOK_NDAPI auto IsStopped() const -> bool;
  ...
  */
  OXGN_COOK_NDAPI auto IsJobActive(ImportJobId job_id) const -> bool;

  //! Check if the service is still accepting new jobs. Thread-safe.
  OXGN_COOK_NDAPI auto IsAcceptingJobs() const -> bool;

  //! Get the total number of active jobs (pending + running).
  OXGN_COOK_NDAPI auto ActiveJobCount() const -> size_t;

  //! Get the number of jobs currently running.
  OXGN_COOK_NDAPI auto RunningJobCount() const -> size_t;

  //! Get the number of jobs queued but not yet running.
  OXGN_COOK_NDAPI auto PendingJobCount() const -> size_t;
