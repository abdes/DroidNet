...
#include <Oxygen/Cooker/Import/TextureSourceAssembly.h> // For CubeFace, kCubeFaceCount
...
*/
OXGN_COOK_NDAPI auto DetectPresetFromFilename(
...
*/
OXGN_COOK_NDAPI auto LoadTexture(const std::filesystem::path& path)
...
/*!
  ...
  @return Decoded ScratchImage on success, or error
*/
OXGN_COOK_NDAPI auto LoadTexture(std::span<const std::byte> data,
...
/*!
  ...
  ```
*/
OXGN_COOK_NDAPI auto LoadTextures(std::span<const std::filesystem::path> paths)
...
*/
OXGN_COOK_NDAPI auto CookScratchImage(ScratchImage&& image,
...
*/
OXGN_COOK_NDAPI auto ImportTexture(
...
/*!
  ...
  ```
*/
OXGN_COOK_NDAPI auto ImportTexture(const std::filesystem::path& path,
  TexturePreset preset, const ITexturePackingPolicy& policy)
  -> Result<TextureImportResult, TextureImportError>;
...
/*!
  ...
  @return Import result on success, or error
*/
OXGN_COOK_NDAPI auto ImportTexture(std::span<const std::byte> data,
...
*/
OXGN_COOK_NDAPI auto ImportCubeMap(
...
/*!
  ...
  ```
*/
OXGN_COOK_NDAPI auto ImportCubeMap(const std::filesystem::path& base_path,
  TexturePreset preset, const ITexturePackingPolicy& policy)
  -> Result<TextureImportResult, TextureImportError>;
...
*/
OXGN_COOK_NDAPI auto ImportCubeMapFromEquirect(
...
/*!
  ...
  ```
*/
OXGN_COOK_NDAPI auto ImportTextureArray(
...
/*!
  ...
  ```
*/
OXGN_COOK_NDAPI auto ImportTexture3D(
...
public:
  ...
  OXGN_COOK_API TextureImportBuilder();

  //! Move constructor.
  OXGN_COOK_API TextureImportBuilder(TextureImportBuilder&& other) noexcept;

  //! Move assignment.
  OXGN_COOK_API auto operator=(TextureImportBuilder&& other) noexcept
  ...
  */
  OXGN_COOK_API auto FromFile(std::filesystem::path path)
    -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto FromMemory(std::vector<std::byte> data,
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto AddCubeFace(CubeFace face, std::filesystem::path path)
    -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto AddArrayLayer(uint16_t layer, std::filesystem::path path)
    -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto AddDepthSlice(uint16_t slice, std::filesystem::path path)
    -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto WithPreset(TexturePreset preset) -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto WithDescriptor(const TextureImportDesc& desc)
    -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto WithTextureType(TextureType type) -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto WithOutputFormat(Format format) -> TextureImportBuilder&;
  ...
  */
  OXGN_COOK_API auto WithSourceColorSpace(ColorSpace space)
    -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto WithMipPolicy(MipPolicy policy) -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto WithMaxMipLevels(uint8_t levels) -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto WithMipFilter(MipFilter filter) -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto FlipNormalGreen(bool flip = true) -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto RenormalizeNormalsInMips(bool renormalize = true)
    -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto FlipYOnDecode(bool flip = true) -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto WithBc7Quality(Bc7Quality quality)
    -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto WithHdrHandling(HdrHandling handling)
    -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Reference to this builder for chaining
  */
  OXGN_COOK_API auto WithExposure(float ev) -> TextureImportBuilder&;
  ...
  /*!
    ...
    @return Import result on success, or error
  */
  OXGN_COOK_NDAPI auto Build(const ITexturePackingPolicy& policy)
    -> Result<TextureImportResult, TextureImportError>;
