...
public:
  ...
  OXGN_COOK_NDAPI auto Rename(std::string_view authored_name,
...
public:
  ...
  */
  ...
  OXGN_COOK_NDAPI auto GetNameCount(ImportNameKind kind) const -> size_t;
