...
static const uint K_ENVIRONMENT_DYNAMIC_DOMAIN_BASE = 0;
static const uint K_ENVIRONMENT_DYNAMIC_CAPACITY = 1;
...
#define BX_DOMAIN_ENVIRONMENT_DYNAMIC_BASE K_ENVIRONMENT_DYNAMIC_DOMAIN_BASE
#define BX_DOMAIN_ENVIRONMENT_DYNAMIC_CAPACITY K_ENVIRONMENT_DYNAMIC_CAPACITY
#define BX_IN_ENVIRONMENT_DYNAMIC(IDX)  BX_IsInDomain((IDX), BX_DOMAIN_ENVIRONMENT_DYNAMIC_BASE, BX_DOMAIN_ENVIRONMENT_DYNAMIC_CAPACITY)
#define BX_TRY_ENVIRONMENT_DYNAMIC(IDX) BX_TryUseGlobalIndexInDomain((IDX), BX_DOMAIN_ENVIRONMENT_DYNAMIC_BASE, BX_DOMAIN_ENVIRONMENT_DYNAMIC_CAPACITY)
