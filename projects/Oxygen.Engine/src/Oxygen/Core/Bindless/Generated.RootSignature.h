...
// Root constants at b2, space0 (2×32-bit).
// - DWORD0: g_DrawIndex (per-draw index into DrawMetadata).
// - DWORD1: g_PassConstantsIndex (per-pass payload; typically a bindless
//   index for pass-level constants).
