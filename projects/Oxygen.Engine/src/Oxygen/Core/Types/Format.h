...
//! Data format enumeration for binary assets, GPU resources, and
//! general-purpose buffers.
/*!
  Represents the encoding, layout, and interpretation of data elements in memory
  or storage. Used for describing the format of textures, vertex/index buffers,
  asset blobs, and other structured or unstructured data in both graphics and
  non-graphics modules.

  The values are compatible with common graphics APIs (such as Direct3D, Vulkan,
  OpenGL), but are not API-specific. This enum is intended for use in asset
  pipelines, runtime resource management, serialization, and any context where
  explicit data format specification is required.

  @note The enum values are stable for serialization and asset compatibility.
*/
