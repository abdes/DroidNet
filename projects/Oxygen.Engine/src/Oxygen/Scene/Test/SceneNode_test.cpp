...
NOLINT_TEST_F(SceneNodeBasicTest, CopyConstructor_PreservesHandle)
{
    ...
    const auto node1_copy(
        node1); // NOLINT(performance-unnecessary-copy-initialization)
...
//------------------------------------------------------------------------------
// Transform Wrapper and Operations Tests
//------------------------------------------------------------------------------
class SceneNodeTransformTest : public SceneNodeTestBase { };
