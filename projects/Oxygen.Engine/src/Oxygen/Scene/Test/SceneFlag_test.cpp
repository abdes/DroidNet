...
NOLINT_TEST_F(
  SceneFlagInheritanceTest, UpdateValueFromParent_UpdatesInheritedFlagCorrectly)
{
...
NOLINT_TEST_F(
  SceneFlagEdgeCaseTest, SetLocalValueOptimization_RevertToEffectiveClearsDirty)
{
...
NOLINT_TEST_F(
  SceneFlagEdgeCaseTest, ProcessDirtyTransitionTracking_PreviousValuePreserved)
{
