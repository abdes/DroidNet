...
auto SceneQuery::GetTraversal() const noexcept -> SceneTraversal&
{
  // FIXME: bypass the constness for now until we make Traversal const-correct
  return const_cast<SceneTraversal&>(scene_->Traverse());
}
