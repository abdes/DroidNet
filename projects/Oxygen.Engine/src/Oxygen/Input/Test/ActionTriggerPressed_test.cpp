...
NOLINT_TEST(ActionTriggerPressed_Basic, FiresOnceOnActuation)
{
  // Arrange
...
NOLINT_TEST(ActionTriggerPressed_Threshold, NoTriggerBelowActuationThreshold)
{
  // Arrange
  ActionTriggerPressed trigger;
...
NOLINT_TEST(ActionTriggerPressed_Axis, TriggersOnlyAboveThreshold)
{
  // Arrange
  ActionTriggerPressed trigger;
...
NOLINT_TEST(ActionTriggerPressed_Cancellation, NeverCanceled)
{
  // Arrange
  ActionTriggerPressed trigger;
  ActionValue v { false };
...
NOLINT_TEST(ActionTriggerPressed_Axis, NegativeCrossesThreshold)
{
  // Arrange
  ActionTriggerPressed trigger;
  trigger.SetActuationThreshold(0.40F);
