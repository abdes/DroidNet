...
NOLINT_TEST(ActionTriggerReleased_Basic, TriggersOnReleaseAfterPress)
{
  // Arrange
...
NOLINT_TEST(ActionTriggerReleased_Edge, NoTriggerOnReleaseWithoutPriorPress)
{
  ActionTriggerReleased trigger;
  ActionValue v { false };
  trigger.UpdateState(v, Duration::zero());
...
NOLINT_TEST(ActionTriggerReleased_Threshold, NoTriggerBelowActuationThreshold)
{
  // Arrange
  ActionTriggerReleased trigger;
...
NOLINT_TEST(ActionTriggerReleased_Axis, TriggersOnPositiveFall)
{
  // Arrange
  ActionTriggerReleased trigger;
...
NOLINT_TEST(ActionTriggerReleased_Axis, TriggersOnNegativeRiseToZero)
{
  // Arrange
  ActionTriggerReleased trigger;
  trigger.SetActuationThreshold(0.40F);
...
NOLINT_TEST(ActionTriggerReleased_Cancellation, NeverCanceled)
{
  // Arrange
  ActionTriggerReleased trigger;
  ActionValue v { false };
