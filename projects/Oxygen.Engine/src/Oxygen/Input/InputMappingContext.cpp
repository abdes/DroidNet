...
auto SimilarSlots(const InputSlot& mapping_slot, const InputSlot& event_slot,
...
void InputMappingContext::HandleInput(
  const InputSlot& slot, const InputEvent& event) const
{
