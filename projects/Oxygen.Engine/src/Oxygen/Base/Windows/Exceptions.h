...
public:
    static auto FromLastError() noexcept -> std::exception_ptr { return FromErrorCode(GetLastError()); }
    OXYGEN_BASE_API static auto FromErrorCode(DWORD error_code) noexcept -> std::exception_ptr;
