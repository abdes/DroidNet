...
using oxygen::make_observer;
using oxygen::observer_ptr;

//-----------------------------------------------------------------------------
// ObserverPtrTest - unit tests for oxygen::observer_ptr
//-----------------------------------------------------------------------------
...
NOLINT_TEST(ObserverPtrTest, ConceptConstraintsCompliance)
{
  ...
  observer_ptr<int> int_ptr;
  observer_ptr<void> void_ptr;
  observer_ptr<const int> const_int_ptr;
  observer_ptr<volatile int> volatile_int_ptr;
  observer_ptr<const volatile int> cv_int_ptr;

  // Test incomplete types (forward declaration should work)
  struct IncompleteType;
  observer_ptr<IncompleteType> incomplete_ptr;
  ...
  static_assert(oxygen::ObservableType<int>);
  static_assert(oxygen::ObservableType<void>);
  static_assert(oxygen::ObservableType<const int>);
  static_assert(oxygen::ObservableType<int[5]>);
  static_assert(!oxygen::ObservableType<int&>);
  static_assert(!oxygen::ObservableType<const int&>);

  static_assert(oxygen::Dereferenceable<int>);
  static_assert(oxygen::Dereferenceable<const int>);
  static_assert(!oxygen::Dereferenceable<void>);
