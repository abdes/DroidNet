...
public:
    ...
    [[nodiscard]] OXYGEN_BASE_API auto write(const char* data, size_t size) noexcept -> Result<void>;
    [[nodiscard]] OXYGEN_BASE_API auto read(char* data, size_t size) noexcept -> Result<void>;
    [[nodiscard]] OXYGEN_BASE_API auto flush() const noexcept -> Result<void>;
    [[nodiscard]] OXYGEN_BASE_API auto position() const noexcept -> Result<size_t>;
    ...
    */
    ...
    [[nodiscard]] OXYGEN_BASE_API auto data() const noexcept -> std::span<const std::byte>;
