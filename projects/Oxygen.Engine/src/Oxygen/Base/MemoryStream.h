...
public:
    ...
    OXYGEN_BASE_API [[nodiscard]] auto write(const char* data, size_t size) noexcept -> Result<void>;
    OXYGEN_BASE_API [[nodiscard]] auto read(char* data, size_t size) noexcept -> Result<void>;
    OXYGEN_BASE_API [[nodiscard]] auto flush() const noexcept -> Result<void>;
    OXYGEN_BASE_API [[nodiscard]] auto position() const noexcept -> Result<size_t>;
    ...
    */
    OXYGEN_BASE_API [[nodiscard]] auto seek(size_t pos) noexcept -> Result<void>;
    OXYGEN_BASE_API [[nodiscard]] auto size() const noexcept -> Result<size_t>;

    OXYGEN_BASE_API [[nodiscard]] auto data() const noexcept -> std::span<const std::byte>;
    OXYGEN_BASE_API void reset() noexcept;
    OXYGEN_BASE_API void clear();
    OXYGEN_BASE_API [[nodiscard]] auto eof() const noexcept -> bool;
