...
public:
    ...
    OXYGEN_PLATFORM_API virtual ~Window();
    ...
    OXYGEN_PLATFORM_API auto Maximize() -> void;
    OXYGEN_PLATFORM_API auto Restore() -> void;
    OXYGEN_PLATFORM_API auto Size(PixelExtent const& extent) -> void;
    OXYGEN_PLATFORM_API [[nodiscard]] auto OnResized() const
        -> sigslot::signal<PixelExtent>&;
    OXYGEN_PLATFORM_API [[nodiscard]] auto OnMinimized() const -> sigslot::signal<>&;
    OXYGEN_PLATFORM_API [[nodiscard]] auto OnRestored() const -> sigslot::signal<>&;
    OXYGEN_PLATFORM_API [[nodiscard]] auto OnMaximized() const -> sigslot::signal<>&;
    ...
    OXYGEN_PLATFORM_API auto RequestNotToClose() const -> void;
    OXYGEN_PLATFORM_API auto RequestClose(bool force = false) -> void;

    OXYGEN_PLATFORM_API [[nodiscard]] auto ShouldClose() const -> bool;

    OXYGEN_PLATFORM_API [[nodiscard]] auto OnCloseRequested() const -> sigslot::signal<bool>&;
    OXYGEN_PLATFORM_API [[nodiscard]] auto OnClosing() const -> sigslot::signal<>&;
