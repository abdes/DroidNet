...
auto oxygen::clap::OptionBuilder::Short(std::string short_name) -> Self&
{
...
auto oxygen::clap::OptionBuilder::Long(std::string long_name) -> Self&
{
  DCHECK_NOTNULL_F(option_, "builder used after Build() was called");
...
auto oxygen::clap::OptionBuilder::About(std::string about) -> Self&
{
  DCHECK_NOTNULL_F(option_, "builder used after Build() was called");
...
auto oxygen::clap::OptionBuilder::Required() -> Self&
{
  DCHECK_NOTNULL_F(option_, "builder used after Build() was called");
  option_->Required();
  return *this;
...
auto oxygen::clap::OptionBuilder::UserFriendlyName(std::string name) -> Self&
{
  DCHECK_NOTNULL_F(option_, "builder used after Build() was called");
