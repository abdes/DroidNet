...
auto FindApplet(const std::vector<AppletInfo>& applets, std::string_view name)
  -> const AppletInfo*
{
...
auto PrintAppletList(const std::vector<AppletInfo>& applets, bool full) -> void
{
  if (full) {
...
auto main(int argc, char** argv) -> int
{
  ...
  try {
    ...
    const std::shared_ptr<Command> ls_command
      = CommandBuilder("ls")
    ...
    const std::shared_ptr<Command> grep_command
      = CommandBuilder("grep")
    ...
    const std::shared_ptr<Command> echo_command
      = CommandBuilder("echo")
    ...
    const std::shared_ptr<Command> cat_command
      = CommandBuilder("cat")
    ...
    const std::shared_ptr<Command> head_command
      = CommandBuilder("head")
    ...
    const std::shared_ptr<Command> tail_command
      = CommandBuilder("tail")
    ...
    const std::shared_ptr<Command> rm_command
      = CommandBuilder("rm")
    ...
    const std::shared_ptr<Command> cp_command
      = CommandBuilder("cp")
    ...
    const std::shared_ptr<Command> mv_command
      = CommandBuilder("mv")
    ...
    const std::shared_ptr<Command> mkdir_command
    ...
    const std::shared_ptr<Command> uname_command
      = CommandBuilder("uname")
    ...
    const std::shared_ptr<Command> busybox_command
      = CommandBuilder("busybox")
          .About("Invoke an applet by name.")
          .WithPositionalArguments(Option::Positional("APPLET")
