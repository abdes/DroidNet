...
public:
  ...
  auto SetFogExtinctionSigmaTPerMeter(float value) -> void;
  [[nodiscard]] auto GetFogHeightFalloffPerMeter() const -> float;
  auto SetFogHeightFalloffPerMeter(float value) -> void;
  ...
  auto SetSunShadowNormalBias(float value) -> void;
  [[nodiscard]] auto GetSunShadowResolutionHint() const -> int;
  auto SetSunShadowResolutionHint(int value) -> void;
  [[nodiscard]] auto GetSunShadowCascadeCount() const -> int;
  auto SetSunShadowCascadeCount(int value) -> void;
  [[nodiscard]] auto GetSunShadowSplitMode() const -> int;
  auto SetSunShadowSplitMode(int value) -> void;
  [[nodiscard]] auto GetSunShadowMaxDistance() const -> float;
  auto SetSunShadowMaxDistance(float value) -> void;
  [[nodiscard]] auto GetSunShadowDistributionExponent() const -> float;
  auto SetSunShadowDistributionExponent(float value) -> void;
  [[nodiscard]] auto GetSunShadowTransitionFraction() const -> float;
  auto SetSunShadowTransitionFraction(float value) -> void;
  [[nodiscard]] auto GetSunShadowDistanceFadeoutFraction() const -> float;
  auto SetSunShadowDistanceFadeoutFraction(float value) -> void;
  [[nodiscard]] auto GetSunShadowCascadeDistance(int index) const -> float;
