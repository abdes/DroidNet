...
This plan executes `design/content-pipeline/physics-cooking-architecture.md`.
...
1. `design/content-pipeline/physics-cooking-architecture.md`
2. `design/content-pipeline/physics-cooking-implementation-plan.md`
...
1. Verify canonical physics contracts between:
   - `design/content-pipeline/pak-v7-physics-format-specification.md`
...
1. P0 `done`:
   - evidence: `design/content-pipeline/physics-cooking-architecture.md`, `design/content-pipeline/physics-cooking-implementation-plan.md`.
2. P11 `done`:
   - evidence:
     - docs: `design/content-pipeline/pak-v7-physics-format-specification.md`, `design/content-pipeline/physics-cooking-architecture.md`.
...
12. P10 `in_progress`:
    ...
    - progress evidence:
      ...
      - spec updated with repository-backed examples and parity evidence mapping:
        - `design/content-pipeline/physics-cooking-architecture.md` sections 6.5 and 13.

## P0

1. Replaced sidecar-only physics design/plan with comprehensive scope:
   - `design/content-pipeline/physics-cooking-architecture.md`
   - `design/content-pipeline/physics-cooking-implementation-plan.md`
...
1. Canonical physics contract updates applied in docs:
   - `design/content-pipeline/pak-v7-physics-format-specification.md` updated to align with `PakFormat_physics.h`.
   - `design/content-pipeline/physics-cooking-architecture.md` updated with final contract content.
...
4. Progress evidence:
   - docs updated:
     - `design/content-pipeline/physics-cooking-architecture.md` now references concrete repository examples
       for four-domain physics workflows and parity evidence mapping.
     - `design/content-pipeline/physics-cooking-architecture.md` now explicitly documents vehicle hydration
