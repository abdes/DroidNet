...
**Date:** 2026-03-03
**Status:** Design / Review & Remediation
...
- Cooker + format docs: `design/content-pipeline/physics-cooking-architecture.md`, `design/content-pipeline/pak-v7-physics-format-specification.md`
...
- `design/content-pipeline/pak-v7-physics-format-specification.md`, `design/content-pipeline/physics-cooking-architecture.md`
...
- `Examples/DemoShell/Services/SceneLoaderService.cpp`
- `design/content-pipeline/physics-cooking-architecture.md`, `design/content-pipeline/pak-v7-physics-format-specification.md`
