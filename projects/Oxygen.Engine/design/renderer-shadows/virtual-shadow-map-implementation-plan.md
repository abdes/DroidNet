...
`design/renderer-shadows/virtual-shadow-map-architecture.md`
...
- `design/renderer-shadows/virtual-shadow-map-architecture.md` - authoritative architecture spec
...
- The optimization method, UE5 reference model, and tooling workflow are
  recorded in `design/renderer-shadows/virtual-shadow-map-performance-playbook.md`.
