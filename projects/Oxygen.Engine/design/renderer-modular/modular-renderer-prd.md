...
See [IMPLEMENTATION-STATUS.md](modular-renderer-implementation-status.md) for proof artifacts.
...
4. The phase-1 capability-family model defined in
   [ARCHITECTURE.md](modular-renderer-architecture.md) is the architectural basis of the
   system.
...
5. A short "Capability-Family Service Extraction Guide" section exists in
   [DESIGN.md](modular-renderer-design.md) that a developer can follow to extract the next
   family.
