...
Implement `design/pak_builder.md` end-to-end with:
...
11. Acceptance criteria authority is frozen to this file and `design/pak_builder.md` only; no external notes/reviews/chats are normative unless promoted into one of these files with formal approval.
...
1. Normative design text:
   - [`design/pak_builder.md`](/F:/projects/DroidNet/projects/Oxygen.Engine/design/pak_builder.md) Section 11.
...
3. Freeze acceptance criteria in this file and `design/pak_builder.md` only.
...
3. Acceptance criteria lock text exists in this file and `design/pak_builder.md`.
