...
- [Captured-sky IBL algorithm](captured-sky-ibl.md)
- [Deferred capability boundaries](../milestones/ED-M08/deferred-capabilities.md)
...
cascade setup and 3x3 PCF. The [EX07 shadow-memory audit](../milestones/exposure/EX07/EX07E/shadow-memory.md)
...
using IDs/links from [the deferred record](../milestones/ED-M08/deferred-capabilities.md).
