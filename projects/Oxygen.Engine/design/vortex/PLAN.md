...
| Multi-view | VTX-M06A | `in_progress` | B1 per-view plan/state-handle substrate, B2 classification payloads, C serialized view-family loop, D scene-texture lease pool, and E data-driven surface composition have focused build/test evidence; auxiliary views, overlays, and runtime/capture proof remain open. |
