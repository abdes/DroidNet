...
| VTX-M06A | Multi-view proof closeout | `in_progress` | VTX-M05A, VTX-M05B, VTX-M05C, VTX-M05D | B1 per-view plan/state-handle substrate, B2 classification payloads, and C `PerViewScope` serialized view-family loop have focused build/test and RenderScene smoke evidence; D-I and runtime/capture closure proof remain open. |
...
| Multi-view | VTX-M06A | `in_progress` | B1 per-view plan/state-handle substrate, B2 classification payloads, and C serialized view-family loop have focused build/test evidence; leases, data-driven composition, auxiliary views, overlays, and runtime/capture proof remain open. |
