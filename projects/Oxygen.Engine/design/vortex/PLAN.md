...
processing, and gated GPU product upload groundwork is in progress with focused
tests and ShaderBake/catalog validation. Skybox rendering, shader ABI
migration, diffuse SkyLight consumption, and proof closeout remain open.
