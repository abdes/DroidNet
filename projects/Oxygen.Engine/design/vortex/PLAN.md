...
| VTX-M06A | Multi-view proof closeout | `in_progress` | VTX-M05A, VTX-M05B, VTX-M05C, VTX-M05D | B1 per-view plan/state-handle substrate and B2 classification payloads have focused build/test evidence; C-I and runtime/capture proof remain open. |
...
| Multi-view | VTX-M06A | `in_progress` | B1 per-view plan/state-handle substrate and B2 classification payloads have focused build/test evidence; multi-view loop, leases, data-driven composition, auxiliary views, overlays, and runtime/capture proof remain open. |
