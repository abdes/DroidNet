...
| Offscreen rendering | VTX-M06B | `in_progress` | Scene-derived offscreen facade with deferred/forward coverage. Slices A-D have source/test proof for execution, pipeline routing, and product final state; runtime visual proof, CDB/debug-layer audit, RenderDoc scripted analysis, and allocation-churn proof remain open. |
