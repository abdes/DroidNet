...
follow-up captures. Paired focused RenderDoc captures now prove measurable
local-fog and SkyLight deltas in `IntegratedLightScattering`; the SkyLight proof
