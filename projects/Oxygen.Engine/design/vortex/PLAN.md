...
validated. Slice B product-state/ABI groundwork is in progress with focused
tests and ShaderBake/catalog validation. Cubemap processing, skybox rendering,
diffuse SkyLight consumption, and proof closeout remain open.
