...
| VTX-M04D.4 | UE5.7 volumetric fog parity | `in_progress` | VTX-M04D.1, VTX-M04D.2, VTX-M04D.3, VTX-M03 directional CSM proof | First integrated-light-scattering runtime product path exists with focused Stage-14 RenderDoc proof and captured Stage-15 fog static-data SRV/flag proof. UE5.7-style log froxel depth, primary/secondary height-fog spatial media density, primary directional CSM shadowed-light sampling, and a first local-fog participating-media injection path now exist with focused CPU/shader evidence. Sky-light injection, temporal history/reprojection, volumetric shadow/local-fog artifact proof, and city-scale capture proof remain open. |
...
| Volumetric fog | VTX-M04D.4 | `in_progress` | First integrated-light-scattering runtime path exists with focused RenderDoc proof for Stage-14 dispatch/product write plus captured Stage-15 fog `EnvironmentStaticData` SRV/flag/grid proof. UE5.7-style log froxel depth, spatial primary/secondary height-fog media density, primary directional CSM shadowed-light sampling, and local-fog participating-media injection through validated Stage-14 tiled products now exist with focused CPU/shader evidence. Sky-light injection, temporal history/reprojection, volumetric shadow/local-fog artifact proof, and city-scale capture proof remain open. |
