...
| Multi-view | VTX-M06A | `in_progress` | B1 per-view plan/state-handle substrate, B2 classification payloads, C serialized view-family loop, and D scene-texture lease pool have focused build/test evidence; data-driven composition, auxiliary views, overlays, and runtime/capture proof remain open. |
