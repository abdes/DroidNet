...
CSM portion of `VTX-M05D` is validated, but spot-light conventional shadows and
the explicit point-light strategy/implementation still remain in the M05D
scope.
