...
| Aerial perspective is not UE5.7 parity-closed. | Atmosphere parity and environment runtime proof. | Complete VTX-M04D.6: map current AP generation/sampling/application to UE5.7, remediate gaps, add focused tests, run shader validation where needed, and record runtime/capture proof. |
