...
**Why:** `VTX-M05A` through `VTX-M05D` are validated. The conventional
shadow-map baseline now covers directional CSM, spot-light shadows, and
point-light shadows for deferred Stage 12 lighting.
...
**Current VTX-M06A status:** `planned`.
