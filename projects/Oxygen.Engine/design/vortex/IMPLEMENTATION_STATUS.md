...
recoverable issues, and major SceneRenderer pass/product writer hooks. Capture
manifest, GPU timeline facade, panel integration, proof script hardening,
runtime capture, ShaderBake, and debug-layer evidence remain open until their
slices land.
