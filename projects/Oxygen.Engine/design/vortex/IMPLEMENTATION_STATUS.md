...
**Next action:** close CPU accounting with the supplemental benchmark explicitly
authorized by the user after the final report. Copy attribution is closed by
the frozen-source and recorded-scope audit. The 48-run GPU matrix, event scripts,
