...
docs/status, capture evidence, debug-layer evidence, and manual visual confirmation. This does not close full VTX-M04D.4 volumetric-fog parity.
...
Validation recorded in `milestone README` covers focused build,
...
audit, and manual visual confirmation of projected shadows.
...
Manual visual confirmation on 2026-04-26: `CityEnvironmentValidation` now has
...
[`VTX-M05D-conventional-shadow-parity.md`](../VTX-M05D/README.md).
...
- manual visual confirmation of projected shadows in the target scene
