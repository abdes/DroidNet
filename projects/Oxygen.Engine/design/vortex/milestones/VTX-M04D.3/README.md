...
- Oxygen composes local fog in a dedicated Stage 15 pass and injects local
  volumes into volumetric fog in Stage 14. M04D.3 qualifies the analytic path;
  [M04D.4](../VTX-M04D.4/README.md) records injection and volumetric integration.
