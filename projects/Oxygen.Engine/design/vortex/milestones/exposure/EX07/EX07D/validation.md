...
Current accepted measurements are in the [E comparison report](../EX07E/validation.md);
[F acceptance](../EX07F/validation.md) and overall EX07 are closed.
...
F credits those results, qualified build repairs and final editor approval;
...
evidence under `design/vortex/milestones/exposure/EX07/EX07D/evidence/baselines/ex07d-20260924`; deleting the transient
...
inventory is [versioned](evidence/baselines/ex07d-20260924/hardware-cpu.json).
...
The [versioned register](evidence/baselines/ex07d-20260924/register.json) indexes the
[full benchmark records](evidence/baselines/ex07d-20260924/benchmark-baselines.json),
four application records and [historical controls](evidence/baselines/ex07d-20260924/historical-controls.json).
...
[Replay inputs](evidence/baselines/ex07d-20260924/replay-inputs.json) preserve the original
...
The [frozen recipe](evidence/baselines/ex07d-20260924/LightingWorkloads.json) is revision 2.
...
![Deferred primary](evidence/baselines/ex07d-20260924/primary-deferred.png)

![Forward primary](evidence/baselines/ex07d-20260924/primary-forward.png)
...
are recorded in [Instancing Tracy](evidence/baselines/ex07d-20260924/instancing-tracy.json)
and [Sponza Tracy](evidence/baselines/ex07d-20260924/sponza-tracy.json). Native frame records:
[Instancing](evidence/baselines/ex07d-20260924/instancing-native.json),
[Sponza](evidence/baselines/ex07d-20260924/sponza-native.json).
...
![Instancing frozen view](evidence/baselines/ex07d-20260924/instancing.png)

![New Sponza frozen view](evidence/baselines/ex07d-20260924/sponza.png)
...
Raw Tracy files: [Instancing](evidence/baselines/ex07d-20260924/instancing.tracy) and
[Sponza](evidence/baselines/ex07d-20260924/sponza.tracy).
...
| Final F acceptance                       | Integrated relevant matrix with matched collection, real application interaction, manual visual approval and explicit supported operating budgets. Reuse unaffected evidence; no automatic fresh campaign just because the stage label changes. |

The [regression analysis](../EX07C/sponza-analysis.md) and
[execution plan](../EX07E/validation.md#recorded-e-priorities-after-the-new-sponza-regression-analysis)
