...
The [D register](../EX07D/validation.md) preserves the initial comparison
points, and the [accepted E report](../EX07E/validation.md) records the
subsequent optimization and approved PCF quality/cost decisions. Timings below
retain their original diagnostic scope. [F engine acceptance](../EX07F/validation.md)
and overall EX07 are closed, including manually verified editor interaction. The
