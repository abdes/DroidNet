...
user acceptance are recorded in [EX10 closeout](EX10-completion.md). The initial
...
Durable records: [summary and hashes](validation/ex08-20260925/summary.json),
[Debug results](validation/ex08-20260925/lightbench-ex08-debug.json.gz),
[Release results](validation/ex08-20260925/lightbench-ex08-release.json.gz),
[final indoor Debug](validation/ex08-20260925/lightbench-ex08-indoor-debug.json.gz),
[final indoor Release](validation/ex08-20260925/lightbench-ex08-indoor-release.json.gz).
...
[Toggle Debug](validation/ex08-20260925/lightbench-ex08-toggle-debug.json.gz),
[Toggle Release](validation/ex08-20260925/lightbench-ex08-toggle-release.json.gz).
The Release app was rebuilt and reopened for a focused manual retest.

## Final acceptance

The user confirmed the corrected directional checkbox (off darkens the cards;
...
See [the final result and migration records](EX082-execution.md).
...
The user confirmed responsive UI and supplied a modified Full-scene image with
...
numerical tolerance was changed. [Result](validation/ex08-20260925/lightbench-ex08-auto-release.json.gz)
