...
| [exposure-contract-checkpoint.md](exposure-contract-checkpoint.md) | Compiler/numerical audit evidence, owned GPU/asset contracts, HDR inventory and FP16 eligibility decision for slice 1. |
