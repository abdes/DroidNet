...
The user explicitly retained EX08.1 before EX10.
...
[Durable results](validation/ex081-20260925/summary.json) include raw result/log
...
[EX08.2 migration record](EX082-execution.md) preserves the renamed/simplified
LightBench CPU checks and real-app results. Native renderer tests remain the
authority for transition consumption/history; no new GPU capture is claimed.
