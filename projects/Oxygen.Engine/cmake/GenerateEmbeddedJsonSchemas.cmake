...
#
# It is the implementation backend used by `oxygen_embed_json_schemas()` from
...
#     OXYGEN_JSON_SCHEMA_OUTPUT_HEADER : absolute output header path
#     OXYGEN_JSON_SCHEMA_NAMESPACE     : target C++ namespace
...
#
# Output:
# - Writes OXYGEN_JSON_SCHEMA_OUTPUT_HEADER containing:
...
if(
  ...
  message(FATAL_ERROR "Manifest is missing OXYGEN_JSON_SCHEMA_OUTPUT_HEADER.")
endif()
if(
  NOT
    DEFINED
      OXYGEN_JSON_SCHEMA_NAMESPACE
  OR
    OXYGEN_JSON_SCHEMA_NAMESPACE
      STREQUAL
      ""
)
  message(FATAL_ERROR "Manifest is missing OXYGEN_JSON_SCHEMA_NAMESPACE.")
endif()
if(
  NOT
    DEFINED
      OXYGEN_JSON_SCHEMA_CHUNK_SIZE
  OR
    OXYGEN_JSON_SCHEMA_CHUNK_SIZE
      STREQUAL
      ""
)
  message(FATAL_ERROR "Manifest is missing OXYGEN_JSON_SCHEMA_CHUNK_SIZE.")
endif()
...
if(NOT DEFINED OXYGEN_JSON_SCHEMA_NAMES OR NOT DEFINED OXYGEN_JSON_SCHEMA_FILES)
  message(
    FATAL_ERROR
    "Manifest is missing OXYGEN_JSON_SCHEMA_NAMES/OXYGEN_JSON_SCHEMA_FILES."
  )
endif()

list(LENGTH OXYGEN_JSON_SCHEMA_NAMES _schema_name_count)
list(LENGTH OXYGEN_JSON_SCHEMA_FILES _schema_file_count)
