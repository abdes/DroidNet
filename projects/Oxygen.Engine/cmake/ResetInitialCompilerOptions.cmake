...
macro(strip_unwanted_options_from cmake_flags)
  ...
  if(${cmake_flags} MATCHES "/GR")
    string(REPLACE "/GR" "" ${cmake_flags} ${${cmake_flags}})
  endif()
endmacro()
...
if(MSVC AND USE_CCACHE)
  ...
  # Also, /GR option for RTTI should be explicitly enabled in the project.
  # Same for /INCREMENTAL option. Incompatible with sanitizers.
