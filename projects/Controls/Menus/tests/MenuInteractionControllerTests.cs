...
public sealed partial class MenuInteractionControllerTests : VisualUserInterfaceTests
{
    ...
    public Task OnPointerEntered_ReenteringActiveRoot_ShouldNotDuplicateRequests() => EnqueueAsync(() =>
    {
        ...
        harness.Controller.OnFocusRequested(harness.RootContext, origin, root, MenuInteractionInputSource.PointerInput, openSubmenu: true);
        harness.ResetSurfaces();
    ...
    public Task OnFocusRequested_WithKeyboardWithoutOpening_SubmenuShouldRemainClosed() => EnqueueAsync(() =>
    {
        ...
        harness.ResetSurfaces();
        harness.Controller.OnFocusRequested(harness.RootContext, origin, root, MenuInteractionInputSource.KeyboardInput, openSubmenu: false);
    ...
    public Task OnSubmenuRequested_FromColumn_ShouldFocusItemAndOpenChildColumn() => EnqueueAsync(() =>
    {
        ...
        harness.ResetSurfaces();
        harness.Controller.OnSubmenuRequested(harness.ColumnContext(1), origin, parent, MenuInteractionInputSource.PointerInput);
        ...
        harness.ColumnMock.Verify(m => m.OpenChildColumn(It.Is<MenuItemData>(mi => ReferenceEquals(mi, parent)), origin, 2, MenuNavigationMode.PointerInput), Times.Once());
    });
    ...
    public Task OnSubmenuRequested_FromColumnWithKeyboard_ShouldActivateAndOpenChild() => EnqueueAsync(() =>
    {
        ...
        harness.Controller.OnFocusRequested(harness.RootContext, rootOrigin, root, MenuInteractionInputSource.KeyboardInput, openSubmenu: true);
        var parentOrigin = new TestFrameworkElement();
        harness.Controller.OnFocusRequested(harness.ColumnContext(1), parentOrigin, parent, MenuInteractionInputSource.KeyboardInput, openSubmenu: false);
        harness.ResetSurfaces();

        harness.Controller.OnSubmenuRequested(harness.ColumnContext(1), origin, parent, MenuInteractionInputSource.KeyboardInput);
        ...
        harness.ColumnMock.Verify(m => m.OpenChildColumn(It.Is<MenuItemData>(mi => ReferenceEquals(mi, parent)), origin, 2, MenuNavigationMode.KeyboardInput), Times.Once());
    });
    ...
    public Task OnPointerEntered_ForLeafColumnItem_ShouldNotOpenChildColumn() => EnqueueAsync(() =>
    {
        ...
        var rootOrigin = new TestFrameworkElement();
        harness.Controller.OnFocusRequested(harness.RootContext, rootOrigin, root, MenuInteractionInputSource.PointerInput, openSubmenu: true);
        harness.ResetSurfaces();
    ...
    public void OnInvokeRequested_FromColumn_ShouldInvokeItemAndDismissChain()
    {
        ...
        harness.ResetSurfaces();
        harness.Controller.OnInvokeRequested(harness.ColumnContext(1), item, MenuInteractionInputSource.PointerInput);

        _ = harness.GroupSelections.Should().ContainSingle(x => ReferenceEquals(x, item));

        harness.ColumnMock.Verify(m => m.Invoke(It.Is<MenuItemData>(mi => ReferenceEquals(mi, item)), It.IsAny<MenuInteractionInputSource>()), Times.Once());
    ...
    public void OnInvokeRequested_FromColumnWithKeyboard_ShouldRespectKeyboardState()
    {
        ...
        harness.ResetSurfaces();
        harness.Controller.OnInvokeRequested(harness.ColumnContext(1), item, MenuInteractionInputSource.KeyboardInput);
    ...
    public void OnInvokeRequested_FromRootWithKeyboard_ShouldInvokeAndDismiss()
    {
        ...
        harness.ResetSurfaces();
        harness.Controller.OnInvokeRequested(harness.RootContext, item, MenuInteractionInputSource.KeyboardInput);

        _ = harness.GroupSelections.Should().ContainSingle(x => ReferenceEquals(x, item));

        harness.RootMock.Verify(m => m.Invoke(It.Is<MenuItemData>(mi => ReferenceEquals(mi, item)), It.IsAny<MenuInteractionInputSource>()), Times.Once());
        harness.ColumnMock.Verify(m => m.CloseFromColumn(It.Is<int>(i => i == 0)), Times.AtLeastOnce());
        harness.RootMock.Verify(m => m.CloseFromColumn(It.Is<int>(i => i == 0)), Times.AtLeastOnce());
        harness.RootMock.Verify(m => m.ReturnFocusToApp(), Times.Once());
        _ = harness.Controller.NavigationMode.Should().Be(MenuNavigationMode.KeyboardInput);
    ...
    public Task RequestSubmenu_WithExplicitNavigationMode_ShouldActivateAndOpen() => EnqueueAsync(() =>
    {
        ...
        harness.Controller.OnSubmenuRequested(harness.RootContext, origin, parent, MenuInteractionInputSource.KeyboardInput);
    ...
    public Task Dismiss_ShouldClearStateAndReturnFocus() => EnqueueAsync(() =>
    {
        ...
        harness.Controller.OnFocusRequested(harness.ColumnContext(1), childOrigin, child, MenuInteractionInputSource.PointerInput, openSubmenu: false);
    ...
    public Task OnDismissRequested_ShouldClearActiveItemsAndReturnFocus() => EnqueueAsync(() =>
    {
        ...
        harness.Controller.OnFocusRequested(harness.RootContext, rootOrigin, root, MenuInteractionInputSource.KeyboardInput, openSubmenu: true);
        var childOrigin = new TestFrameworkElement();
        harness.Controller.OnFocusRequested(harness.ColumnContext(1), childOrigin, child, MenuInteractionInputSource.KeyboardInput, openSubmenu: false);
