...
public partial class InPlaceEditableLabel : ContentControl
{
    ...
    protected override void OnApplyTemplate()
    {
        ...
        if (this.GetTemplateChild(LabelContentPresenterPartName) is ContentPresenter contentPresenter)
        {
            contentPresenter.Loaded += (_, _) =>
            {
                this.entityNameTextBlock = FindVisualChild<TextBlock>(contentPresenter);
                if (this.entityNameTextBlock is null)
                {
                    return;
                }

                this.entityNameTextBlock.SetBinding(
    ...
    private void ValidateName()
    {
        ...
        var args = new ValidationEventArgs<string>(this.originalName, this.editTextBox.Text);
