...
/// <remarks>
///     The <see cref="Transform" /> class represents a transform component of a game entity. It includes properties for
///     the position, rotation, and scale of the entity within the scene. The class provides methods for getting and
///     setting these properties.
/// </remarks>
public partial class Transform(SceneNode entity) : GameComponent(entity)
{
