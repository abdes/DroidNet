...
public partial class TestView : IViewFor<TestViewModel>
{
    ...
    public static readonly DependencyProperty ViewModelProperty = DependencyProperty.Register(
        ...
        new PropertyMetadata(
            null,
            (d, e) => ((TestView)d).ViewModelChanged?.Invoke((IViewFor)d, new ViewModelChangedEventArgs<TestViewModel>((TestViewModel)(e.OldValue)))));

    /// <inheritdoc />
    public event EventHandler<ViewModelChangedEventArgs<TestViewModel>>? ViewModelChanged;
