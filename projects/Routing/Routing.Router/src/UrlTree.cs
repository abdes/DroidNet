...
/// <summary>
/// Represented a parsed router URL.
/// </summary>
/// <remarks>
/// Since the <see cref="UrlTree" /> is from a certain point of view a representation of the <see
/// cref="Router" /> state, the URL is a serialized representation of that state.
/// </remarks>
public class UrlTree : IUrlTree
{
    ...
    /// </summary>
    /// <param name="root">
    /// Optional root <see cref="UrlSegmentGroup" />. If not specified, the <see cref="Root" />
    /// property will be initialized with no segments and no children.
    /// </param>
    /// <param name="queryParams">
    /// Optional dictionary of query params. If not present, the <see cref="QueryParams" /> property
    /// will be initialized with an empty collection.
    /// </param>
    ...
    /// <summary>
    /// Serializes the <see cref="UrlTree" /> into a string, using percent-encoding to escape special characters as specified in
    /// <see href="https://datatracker.ietf.org/doc/html/rfc3986">RFC 3986</see>.
    /// </summary>
    /// <returns>A string representing the serialized form of the <see cref="UrlTree" />.</returns>
