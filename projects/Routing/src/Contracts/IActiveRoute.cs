...
public interface IActiveRoute : IActiveRouteTreeNode
{
    ...
    /// </value>
    IReadOnlyList<UrlSegment> UrlSegments { get; init; }

    /// <summary>Gets the parameters for this route.</summary>
    /// <remarks>
    /// Parameters can be passed either as <see cref="UrlSegment">url segments</see>,
    ...
    /// <summary>
    /// Gets the <see cref="Route" /> configuration used to match this route.
    /// </summary>
    /// <value>
    /// The <see cref="Route" /> configuration used to match this route.
    /// </value>
    /// <remarks>
    /// Provided mostly for debugging and troubleshooting.
    /// </remarks>
    Route RouteConfig { get; init; }
}
