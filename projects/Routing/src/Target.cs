...
public record Target
{
    ...
    /// <summary>
    /// Gets a special target, used to refer to the <see cref="RouterContext" />
    /// of the current <see cref="ActiveRoute" />.
    /// </summary>
    /// <remarks>
    /// When a target is not specified for a navigation request, it is assumed
    /// to be <see cref="Self" />.
    /// </remarks>
    /// <value>The target name for the current <see cref="ActiveRoute" />.</value>
