...
/// class.
/// </summary>
[System.Diagnostics.CodeAnalysis.SuppressMessage("Maintainability", "CA1515:Consider making public types internal", Justification = "App must be public")]
    ...
    protected override async void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        try
        {
            await this.router.NavigateAsync(
                "/workspace(dock:(app:Welcome//routes:Config;bottom=url-tree//url-tree:Parser;left;w=300//router-state:Recognizer;right;w=400))",
