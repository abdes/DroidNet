...
public static class ImportSettingsHelper
{
    ...
    public static async Task<IReadOnlyDictionary<string, string>> GetEffectiveSettingsAsync(ImportContext context, CancellationToken cancellationToken)
    {
    ...
    private sealed record SidecarData(IReadOnlyDictionary<string, string>? Settings);
}
