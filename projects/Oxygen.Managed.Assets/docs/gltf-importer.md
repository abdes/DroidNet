...
# glTF 2.0 importer (Oxygen.Managed.Assets) — design & strategy
...
Oxygen.Managed.Assets currently contains an MVP importer that:
...
- **Asset identity** is a stable GUID: `oxygen::data::AssetKey` (engine/runtime) / `AssetKey` (Oxygen.Managed.Assets).
...
### Output VirtualPaths (Oxygen.Managed.Assets convention)
...
##### Importer impact (Oxygen.Managed.Assets)
