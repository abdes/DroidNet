...
assetService.RegisterResolver(new Oxygen.Managed.Assets.Resolvers.GeneratedAssetResolver());
// assetService.RegisterResolver(new Oxygen.Managed.Assets.Resolvers.FileSystemAssetResolver());

var cube = await assetService.LoadAssetAsync<Oxygen.Managed.Assets.GeometryAsset>(
