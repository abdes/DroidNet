...
internal static class TestHelper
{
    ...
    public static AnalyzerConfigOptionsProvider CreateThrowingOptionsProvider(string message)
    {
        return new ThrowingAnalyzerConfigOptionsProvider(message);
    }
    ...
    private sealed class InMemoryAnalyzerConfigOptionsProvider : AnalyzerConfigOptionsProvider
    {
        ...
        {
            this.global = new InMemoryAnalyzerConfigOptions(globalOptions);
        }
        ...
        {
            return InMemoryAnalyzerConfigOptions.Empty;
        }
    ...
    private sealed class ThrowingAnalyzerConfigOptionsProvider : AnalyzerConfigOptionsProvider
    {
        ...
        {
            this.global = new ThrowingAnalyzerConfigOptions(message);
        }
