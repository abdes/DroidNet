...
public sealed partial class DocumentTabPresenter : IDisposable
{
    ...
    private readonly WindowContext hostWindow;
    ...
    public DocumentTabPresenter(Controls.TabStrip tabStrip, IDocumentService documentService, WindowContext hostWindow, DispatcherQueue dispatcher, ILogger? logger = null)
    {
