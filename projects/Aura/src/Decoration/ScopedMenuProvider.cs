...
/// <summary>
///     Menu provider that resolves dependencies from the DI container when
///     creating menu sources.
/// </summary>
/// <remarks>
///     This provider is suitable for menus that require services from the
///     dependency injection container. The configuration action receives a <see
///     cref="MenuBuilder"/> and an <see cref="IServiceProvider"/> allowing you
///     to resolve services and build the menu dynamically.
///     <para>
///     Unlike <see cref="MenuProvider"/>, which uses a simple factory function,
///     this provider integrates with the DI container to provide access to
///     registered services such as command handlers, view models, or
///     application state.
///     </para>
///     <para>
///     The provider is thread-safe and can handle concurrent menu source
///     creation requests.
///     </para>
/// </remarks>
/// <example>
...
///
///             builder.AddMenuItem("New", commandService.NewCommand, null,
///             "Ctrl+N"); builder.AddMenuItem("Open", commandService.OpenCommand,
///             null, "Ctrl+O");
///
