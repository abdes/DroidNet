...
/// </summary>
/// <remarks>
/// The drag region determines which areas of the title bar can be used to drag and move the window.
/// Different behaviors support various UI patterns, from standard desktop windows to custom
/// interactive title bars.
/// </remarks>
public enum DragRegionBehavior
{
    /// <summary>
    /// Standard drag region behavior. The entire title bar area can be used for window dragging,
    /// except for interactive elements like buttons and menus.
    /// </summary>
    Default,
