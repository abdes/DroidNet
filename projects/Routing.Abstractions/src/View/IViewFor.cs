...
/// <summary>
/// Represents a non-generic instance of <see cref="IViewFor{T}" />. Prefer to
/// use the generic version whenever possible and limit the use of the
/// non-generic version to when the type of ViewModel is not important.
/// </summary>
