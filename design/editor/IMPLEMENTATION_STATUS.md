...
- [ ] 07B.2 staged validation, preview pause, publication, rollback/recovery and leases.
  ...
  - [x] Publication can install a privately captured retained source alongside
        ...
        remain ordinary authoring changes. Import request/dialog integration
        remains in 07B.4 and 07B.5d-e.
...
Current validation: ContentPipeline 412/412 and the expanded inspection adapter
