...
- [ ] 07B.1 coherent saved snapshots, dependency freshness, incremental reuse,
  ...
  - [ ] Complete foreign cooked-only input validation/leases and the remaining
        typed-use/qualification matrix. These remain part of 07B.1 and 07B.4.
